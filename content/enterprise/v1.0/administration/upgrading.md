...
```
wget https://s3.amazonaws.com/influx-enterprise/releases/influxdb-meta_1.0.2-c1.0.3_amd64.deb
...
```
wget https://s3.amazonaws.com/influx-enterprise/releases/influxdb-meta-1.0.2_c1.0.3.x86_64.rpm
