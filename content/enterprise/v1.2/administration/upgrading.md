...
Please review the [Changelog](/enterprise/v1.2/about-the-project/release-notes-changelog/) prior to upgrading.
...
from the web console due to [significant changes](/enterprise/v1.2/about-the-project/release-notes-changelog/#v1-0-0)
...
[cluster accounts](/enterprise/v1.2/features/users/#cluster-user-information).
Please see [InfluxEnterprise Users](/enterprise/v1.2/features/users/) for
...
##### Ubuntu & Debian (64-bit)
```
wget https://dl.influxdata.com/enterprise/releases/influxdb-data_1.2.0-c1.2.0_amd64.deb
sudo dpkg -i influxdb-data_1.2.0-c1.2.0_amd64.deb
```
##### RedHat & CentOS (64-bit)
```
wget https://dl.influxdata.com/enterprise/releases/influxdb-data-1.2.0_c1.2.0.x86_64.rpm
sudo yum localinstall influxdb-data-1.2.0_c1.2.0.x86_64.rpm
```
#### Web console

##### Ubuntu & Debian (64-bit)
```
wget https://s3.amazonaws.com/influx-enterprise/releases/influx-enterprise_1.2.0_amd64.deb
sudo dpkg -i influx-enterprise_1.2.0_amd64.deb
```
##### RedHat & CentOS (64-bit)
```
wget https://s3.amazonaws.com/influx-enterprise/releases/influx-enterprise-1.2.0.x86_64.rpm
sudo yum localinstall influx-enterprise-1.2.0.x86_64.rpm
```
...
The [Getting Started](/enterprise/v1.2/introduction/getting_started/) guide offers
...
Next, check out the [release notes](/enterprise/v1.2/about-the-project/release-notes-changelog/) to
see what's new!
