...
alias:
  /enterprise/v1.1/introduction/getting-started/
menu:
  enterprise_1_1:
    weight: 40
    parent: Introduction
...
Now that you successfully [installed and set up](/enterprise/v1.1/introduction/meta_node_installation/) InfluxEnterprise, visit
...
[previous documents](/enterprise/v1.1/introduction/meta_node_installation/).
...
The Cluster Admin account has all [cluster-specific permissions](/enterprise/v1.1/features/users/#permissions).
...
The Web Admin user has all [web-console-specific permissions](/enterprise/v1.1/features/users/#admin-users).
...
Check out the [Features](/enterprise/v1.1/features/) section to see all that
