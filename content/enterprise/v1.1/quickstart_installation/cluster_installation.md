...
Follow the instructions outlined in the [Production Installation](/enterprise/v1.1/production_installation/) section
...
Each server is a [meta node](/enterprise/v1.1/concepts/glossary/#meta-node) and
a [data node](/enterprise/v1.1/concepts/glossary/#data-node), that is, each server
...
Once all of your nodes are joined to the cluster, move on to the [next step](/enterprise/v1.1/quickstart_installation/web_console_installation/)
