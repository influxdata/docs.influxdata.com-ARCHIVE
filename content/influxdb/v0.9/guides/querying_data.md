...
title: Querying Data
alias:
  -/docs/v0.9/query_language/querying_data/
menu:
  influxdb_09:
    weight: 10
    parent: guides
...
#### Authentication
Authentication in InfluxDB is disabled by default. See [Authentication and Authorization](/influxdb/v0.9/administration/authentication_and_authorization/) for how to enable and set up authentication.
...
### InfluxQL
---
Now that you know how to query data, check out the [Data Exploration page](/influxdb/v0.9/query_language/data_exploration/) to get acquainted with InfluxQL.
