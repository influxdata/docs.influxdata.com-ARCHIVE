...
from(bucket:"<database>/<retention_policy>")
  |> range(start: now() -15m)
  |> filter(fn: (r) =>  r._measurement == "measurement_name" and r.region == "north" and r._field == "temp")
  |> mean()
