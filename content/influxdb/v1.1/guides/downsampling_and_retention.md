...
[CQ documentation](/influxdb/v1.1/query_language/continuous_queries/) and
[RP documentation](/influxdb/v1.1/query_language/database_management/#retention-policy-management).
...
[database](/influxdb/v1.1/concepts/glossary/#database) called `food_data`, in
the [measurement](/influxdb/v1.1/concepts/glossary/#measurement) `orders`, and
in the [fields](/influxdb/v1.1/concepts/glossary/#field) `phone` and `website`.
...
Use the
[`CREATE CONTINUOUS QUERY`](/influxdb/v1.1/query_language/continuous_queries/)
...
see
[Database Configuration](/influxdb/v1.1/administration/config/#check-interval-30m0s).
...
together, we recommend looking at the detailed documentation on [CQs](/influxdb/v1.1/query_language/continuous_queries/) and [RPs](/influxdb/v1.1/query_language/database_management/#retention-policy-management)
