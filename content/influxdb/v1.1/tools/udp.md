...
To configure InfluxDB to support writes over UDP you must adjust your [config file](/influxdb/v1.1/administration/config/#udp).
...
To write, just send newline separated [line protocol](/influxdb/v1.1/concepts/glossary/#line-protocol) over UDP.
