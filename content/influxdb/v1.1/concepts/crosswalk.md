...
InfluxDB also recognizes that your [schema](/influxdb/v1.1/concepts/glossary/#schema) preferences may change over time.
...
InfluxDB's [continuous queries](/influxdb/v1.1/concepts/glossary/#continuous-query-cq)
and [retention policies](/influxdb/v1.1/concepts/glossary/#retention-policy-rp) are
...
For more detailed descriptions of the InfluxDB terms mentioned in this section see our [Glossary of Terms](/influxdb/v1.1/concepts/glossary/).
...
See our [data exploration](/influxdb/v1.1/query_language/data_exploration/) page for an in-depth discussion of those topics.
InfluxQL functions include `COUNT`, `MIN`, `MAX`, `MEDIAN`, `DERIVATIVE` and more.
For a full list check out the [functions](/influxdb/v1.1/query_language/functions/) page.

Now that you have the general idea, check out our [Getting Started Guide](/influxdb/v1.1/introduction/getting_started/).
