...
[identifiers](/influxdb/v1.1/concepts/glossary/#identifier) in the query is an
[InfluxQL Keyword](/influxdb/v1.1/query_language/spec/#keywords).
...
[Query Language Documentation](/influxdb/v1.1/query_language/)
...
includes both an [aggregate function](/influxdb/v1.1/query_language/functions/)
and a standalone [field key](/influxdb/v1.1/concepts/glossary/#field-key) or
...
[line protocol](/influxdb/v1.1/concepts/glossary/#line-protocol) includes a
...
[`cache-max-memory-size` setting](/influxdb/v1.1/administration/config/#cache-max-memory-size-524288000)
...
or for datasets with higher [series cardinality](/influxdb/v1.1/concepts/glossary/#series-cardinality).
...
[`_internal` database](/influxdb/v1.1/troubleshooting/statistics/#internal-monitoring)
