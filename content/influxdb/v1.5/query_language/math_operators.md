...
InfluxDB does not support combining mathematical operations with a wildcard (`*`) or [regular expression](/influxdb/v1.5/query_language/data_exploration/#regular-expressions) in the `SELECT` clause.
...
> InfluxQL supports [subqueries](/influxdb/v1.5/query_language/data_exploration/#subqueries) which offer similar functionality to using mathematical operators inside a function call.
