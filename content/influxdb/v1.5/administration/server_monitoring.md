...
Check out the [monitor service README](https://github.com/influxdb/influxdb/blob/1.5/monitor/README.md) and the [internal monitoring blog post](https://influxdb.com/blog/2015/09/22/monitoring_internal_show_stats.html) for more detail.
