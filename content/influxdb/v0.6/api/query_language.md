...
The only exception to this is [continuous queries](/influxdb/v0.6/api/continuous_queries/), which perpetually write their results into one or more time series.
...
You'll always be pairing this up with [a function](/influxdb/v0.6/api/aggregate_functions/) in the `select` clause.
