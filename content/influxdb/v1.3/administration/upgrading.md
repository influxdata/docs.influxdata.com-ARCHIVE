...
2. Update the configuration file
    ...
    Migrate any customizations in the 1.1 configuration file to the [1.2 configuration file](/influxdb/v1.3/administration/config/).
...
Compare your old configuration file against the [1.2 configuration file](/influxdb/v1.3/administration/config/)
