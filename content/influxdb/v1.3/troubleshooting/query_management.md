...
>
```
>***Enterprise Edition clusters:*** To kill queries on a cluster, you need to specify the query on the the originating host (for example, "myhost:8088):
>```sql
>KILL QUERY <qid> ON "<originating_host>" 
>```
