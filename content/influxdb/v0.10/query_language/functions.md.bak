...
See [the documentation on `COUNT()`](http://localhost:1313/influxdb/v0.9/query_language/functions/#count-and-controlling-the-values-reported-for-intervals-with-no-data) for a function-specific use of `fill()`.
