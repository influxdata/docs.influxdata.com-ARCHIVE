...
Calculate the [minimum](http://localhost:1313/influxdb/v0.10/query_language/functions/#min) `water_level` and the [maximum](/influxdb/v0.10/query_language/functions/#max) `water_level` with a single query:
```sql
