...
In InfluxDB 0.9 the JSON write protocol is deprecated and replaced by the [line](https://influxdb.com/docs/v0.10/write_protocols/line.html) [protocol](https://influxdb.com/docs/v0.10/write_protocols/write_syntax.html).
