...
InfluxDB 0.9 supported only hybrid nodes. InfluxDB 0.10 also supports [data-only nodes](/influxdb/v0.10/concepts/glossary/#data-node) as well as [consensus nodes](/influxdb/v0.10/concepts/glossary/#consensus-node).
