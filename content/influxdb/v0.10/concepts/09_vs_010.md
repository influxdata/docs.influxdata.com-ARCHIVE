...
Another option is to have two nodes that act as [hybrid nodes](/influxdb/v0.10/concepts/glossary/#hybrid-node) and one less-powered node that acts as a consensus node.
