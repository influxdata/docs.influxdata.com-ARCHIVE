...
> For details, see [TSM-based data storage and in-memory indexing](/influxdb/v1.6/concepts/storage_engine/).
...
The latter will give us the ability to add things to the query languages like the [SHOW CARDINALITY](/influxdb/v1.6/query_language/spec#show-cardinality) queries.
