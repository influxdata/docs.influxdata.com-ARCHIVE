...
See the [API Reference](/influxdb/v1.6/tools/api/#write) documentation for a complete list of the available query parameters.
...
For more information about writing data with the HTTP API, please see the [API reference documentation](/influxdb/v1.6/tools/api/#write).
