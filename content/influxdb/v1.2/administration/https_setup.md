...
[strongly recommend](/influxdb/v1.2/administration/security_best_practices/)
...
Verify that HTTPS is working by connecting to InfluxDB with the [CLI tool](/influxdb/v1.2/tools/shell/):
```
...
>
Connecting [Telegraf](/telegraf/v1.2/) to an InfluxDB instance that's using
