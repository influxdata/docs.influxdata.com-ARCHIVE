...
If you're looking for less formal documentation see [Data Exploration](/influxdb/v1.2/query_language/data_exploration/), [Schema Exploration](/influxdb/v1.2/query_language/schema_exploration/), [Database Management](/influxdb/v1.2/query_language/database_management/), and [Authentication and Authorization](/influxdb/v1.2/query_language/authentication_and_authorization/).
...
* [Notation](/influxdb/v1.2/query_language/spec/#notation)
* [Query representation](/influxdb/v1.2/query_language/spec/#query-representation)
* [Letters and digits](/influxdb/v1.2/query_language/spec/#letters-and-digits)
* [Identifiers](/influxdb/v1.2/query_language/spec/#identifiers)
* [Keywords](/influxdb/v1.2/query_language/spec/#keywords)
* [Literals](/influxdb/v1.2/query_language/spec/#literals)
* [Queries](/influxdb/v1.2/query_language/spec/#queries)
* [Statements](/influxdb/v1.2/query_language/spec/#statements)
* [Clauses](/influxdb/v1.2/query_language/spec/#clauses)
* [Expressions](/influxdb/v1.2/query_language/spec/#expressions)
* [Other](/influxdb/v1.2/query_language/spec/#other)
* [Query Engine Internals](/influxdb/v1.2/query_language/spec/#query-engine-internals)
...
Subscriptions tell InfluxDB to send all the data it receives to [Kapacitor](https://docs.influxdata.com/kapacitor/v1.2/introduction/).
...
> **NOTE:** Identify the `query_id` from the [`SHOW QUERIES`](/influxdb/v1.2/query_language/spec/#show-queries) output.
