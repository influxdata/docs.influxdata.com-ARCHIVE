...
<table style="width:100%">
  <tr>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#database">database</a></td>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#field-key">field key</a></td>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#field-set">field set</a></td>
  </tr>
  <tr>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#field-value">field value</a></td>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#measurement">measurement</a></td>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#point">point</a></td>
  </tr>
    <tr>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#retention-policy">retention policy</a></td>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#series">series</a></td>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#tag-key">tag key</a></td>
  </tr>
    <tr>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#tag-set">tag set</a></td>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#tag-value">tag value</a></td>
    <td><a href="/influxdb/v1.2/concepts/key_concepts/#timestamp">timestamp</a></td>
  </tr>
</table>

Check out the [Glossary](/influxdb/v1.2/concepts/glossary/) if you prefer the cold, hard facts.
...
[Queries](/influxdb/v1.2/concepts/glossary/#query) that use field values as filters must scan all values that match the other conditions in the query.
...
To optimize your queries, it may be beneficial to rearrange your [schema](/influxdb/v1.2/concepts/glossary/#schema) such that the fields (`butterflies` and `honeybees`) become the tags and the tags (`location` and `scientist`) become the fields:
...
If you're interested in reading more about retention policies, check out [Database Management](/influxdb/v1.2/query_language/database_management/#retention-policy-management).
...
Understanding the concept of a series is essential when designing your [schema](/influxdb/v1.2/concepts/glossary/#schema) and when working with your data in InfluxDB.
...
See [Authentication and Authorization](/influxdb/v1.2/query_language/authentication_and_authorization/) and [Continuous Queries](/influxdb/v1.2/query_language/continuous_queries/) for more on those topics.
...
If you're just starting out, we recommend taking a look at [Getting Started](/influxdb/v1.2/introduction/getting_started/) and the [Writing Data](/influxdb/v1.2/guides/writing_data/) and [Querying Data](/influxdb/v1.2/guides/querying_data/) guides.
