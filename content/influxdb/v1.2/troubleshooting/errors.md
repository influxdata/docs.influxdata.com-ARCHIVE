...
not specify a [database](/influxdb/v1.2/concepts/glossary/#database).
Specify a database with an `ON` clause in the `SHOW` query, with `USE <database_name>` in the
[CLI](/influxdb/v1.2/tools/shell/), or with the `db` query string parameter in
the [HTTP API](/influxdb/v1.2/tools/api/#query-string-parameters) request.
...
number of [series](/influxdb/v1.2/concepts/glossary/#series) in a database to
...
**Resources:**
[Database Configuration](/influxdb/v1.2/administration/config/#max-series-per-database-1000000)
...
[identifiers](/influxdb/v1.2/concepts/glossary/#identifier) in the query is an
[InfluxQL Keyword](/influxdb/v1.2/query_language/spec/#keywords).
...
[Query Language Documentation](/influxdb/v1.2/query_language/)
...
includes both an [aggregate function](/influxdb/v1.2/query_language/functions/)
and a standalone [field key](/influxdb/v1.2/concepts/glossary/#field-key) or
...
**Resources:**
[Data Exploration](/influxdb/v1.2/query_language/data_exploration/#time-syntax-in-queries)

## unable to parse < >: bad timestamp

### Timestamp Syntax
The `bad timestamp` error occurs when the
[line protocol](/influxdb/v1.2/concepts/glossary/#line-protocol) includes a
...
**Resources:**
[Line Protocol Tutorial](/influxdb/v1.2/write_protocols/line_protocol_tutorial/),
[Line Protocol Reference](/influxdb/v1.2/write_protocols/line_protocol_reference/)

## unable to parse < >: time outside range

The `time outside range` error occurs when the timestamp in the
[line protocol](/influxdb/v1.2/concepts/glossary/#line-protocol)
...
**Resources:**
[Line Protocol Tutorial](/influxdb/v1.2/write_protocols/line_protocol_tutorial/#data-types),
[Line Protocol Reference](/influxdb/v1.2/write_protocols/line_protocol_reference/#data-types)
...
[`cache-max-memory-size` setting](/influxdb/v1.2/administration/config/#cache-max-memory-size-524288000)
...
or for datasets with higher [series cardinality](/influxdb/v1.2/concepts/glossary/#series-cardinality).
...
[`_internal` database](/influxdb/v1.2/troubleshooting/statistics/#internal-monitoring)
