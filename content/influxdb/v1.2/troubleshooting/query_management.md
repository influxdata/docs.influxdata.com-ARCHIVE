...
<br>
`qid`&emsp;&emsp;&emsp;&nbsp;The id number of the query. Use this value with [`KILL QUERY`](/influxdb/v1.2/troubleshooting/query_management/#stop-currently-running-queries-with-kill-query).  
...
See [Query Language Reference](/influxdb/v1.2/query_language/spec/#durations)
...
#### Syntax:
Where `qid` is the id of the query from the [`SHOW QUERIES`](/influxdb/v1.2/troubleshooting/query_management/#list-currently-running-queries-with-show-queries) output:
```
KILL QUERY <qid>
```
...
[[coordinator]](/influxdb/v1.2/administration/config/#coordinator) section of the
configuration file.
...
Use this value with [`KILL QUERY`](/influxdb/v1.2/troubleshooting/query_management/#stop-currently-running-queries-with-kill-query).
