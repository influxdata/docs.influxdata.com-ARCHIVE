...
aliases:
    - influxdb/v1.2/administration/statistics/
menu:
  influxdb_1_2:
    weight: 10
...
Check out the [monitor service README](https://github.com/influxdb/influxdb/blob/1.2/monitor/README.md) and the [internal monitoring blog post](https://influxdb.com/blog/2015/09/22/monitoring_internal_show_stats.html) for more detail.
