...
With InfluxDB [installed](/influxdb/v1.2/introduction/installation), you're ready to start doing some awesome things.
In this section we'll use the `influx` [command line interface](/influxdb/v1.2/tools/shell/) (CLI), which is included in all
...
See [Writing Data](/influxdb/v1.2/guides/writing_data/) and [Querying Data](/influxdb/v1.2/guides/querying_data/)
...
> **Note:** More information on the line protocol can be found on the [Write Syntax](/influxdb/v1.2/write_protocols/line_protocol_reference/) page.
...
InfluxQL has many [features and keywords](/influxdb/v1.2/query_language/spec/) that are not covered here,
...
check out the guide on [Writing Data](/influxdb/v1.2/guides/writing_data/).
To further explore the query language,
check out the guide on [Querying Data](/influxdb/v1.2/guides/querying_data/).
For more information on InfluxDB concepts, check out the [Key Concepts]
(/influxdb/v1.2/concepts/key_concepts/) page.
