...
See the [Query Syntax](/influxdb/v0.11/query_language/data_exploration/) page for more information.
...
At the next [retention policy enforcement check](/influxdb/v0.11/administration/config/#retention), InfluxDB immediately drops `Shard Group 1` because all of its data is older than 3 days.
