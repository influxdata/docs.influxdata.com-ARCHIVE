...
_**Descriptions of `[subscriber]` configuration options are available in the [Configuring InfluxDB](/influxdb/v1.7/administration/config/#subscription-settings-subscriber) documentation.**_
