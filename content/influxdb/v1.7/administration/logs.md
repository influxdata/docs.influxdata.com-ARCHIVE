...
For details on these logging configuration options and their corresponding environment variables, see [Logging options](/influxdb/v1.7/administration/config/#logging-settings-logging) in the configuration file documentation.
