...
For details on this command, see [influx_inspect dumptsi](/influxdb/v1.7/tools/influx_inspect/#influx-inspect#dumptsi).
...
For details on this command, see [influx inspect buildtsi](/influxdb/v1.7/tools/influx_inspect/#influx-inspect-buildtsi).
