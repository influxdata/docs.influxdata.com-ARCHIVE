...
A single line of text in [line protocol](/influxdb/v1.7/write_protocols/line_protocol_reference) represents one point in InfluxDB. A point has four components: a measurement, a tag set, a field set, and a timestamp. Each point is uniquely identified by its series and timestamp.
