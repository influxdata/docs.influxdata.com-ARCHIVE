...
If you're looking for less formal documentation see [Data Exploration](/influxdb/v0.13/query_language/data_exploration/), [Schema Exploration](/influxdb/v0.13/query_language/schema_exploration/), [Database Management](/influxdb/v0.13/query_language/database_management/), and [Authentication and Authorization](/influxdb/v0.13/administration/authentication_and_authorization/).
...
* [Notation](/influxdb/v0.13/query_language/spec/#notation)
* [Query representation](/influxdb/v0.13/query_language/spec/#query-representation)
* [Letters and digits](/influxdb/v0.13/query_language/spec/#letters-and-digits)
* [Identifiers](/influxdb/v0.13/query_language/spec/#identifiers)
* [Keywords](/influxdb/v0.13/query_language/spec/#keywords)
* [Literals](/influxdb/v0.13/query_language/spec/#literals)
* [Queries](/influxdb/v0.13/query_language/spec/#queries)
* [Statements](/influxdb/v0.13/query_language/spec/#statements)
* [Clauses](/influxdb/v0.13/query_language/spec/#clauses)
* [Expressions](/influxdb/v0.13/query_language/spec/#expressions)
* [Other](/influxdb/v0.13/query_language/spec/#other)
* [Query Engine Internals](/influxdb/v0.13/query_language/spec/#query-engine-internals)
...
Subscriptions tell InfluxDB to send all the data it receives to [Kapacitor](https://docs.influxdata.com/kapacitor/v0.13/introduction/).
...
> **NOTE:** Identify the `query_id` from the [`SHOW QUERIES`](/influxdb/v0.13/query_language/spec/#show-queries) output.
