...
|---|---|---|
| [COUNT()](/influxdb/v0.13/query_language/functions/#count)  | [BOTTOM()](/influxdb/v0.13/query_language/functions/#bottom)  | [CEILING()](/influxdb/v0.13/query_language/functions/#ceiling)   
| [DISTINCT()](/influxdb/v0.13/query_language/functions/#distinct)  | [FIRST()](/influxdb/v0.13/query_language/functions/#first)  | [DERIVATIVE()](/influxdb/v0.13/query_language/functions/#derivative)  
| [INTEGRAL()](/influxdb/v0.13/query_language/functions/#integral)  | [LAST()](/influxdb/v0.13/query_language/functions/#last)  | [DIFFERENCE()](/influxdb/v0.13/query_language/functions/#difference)  
| [MEAN()](/influxdb/v0.13/query_language/functions/#mean) | [MAX()](/influxdb/v0.13/query_language/functions/#max)  | [ELAPSED()](/influxdb/v0.13/query_language/functions/#elapsed)
| [MEDIAN()](/influxdb/v0.13/query_language/functions/#median)  | [MIN()](/influxdb/v0.13/query_language/functions/#min)  |  [FLOOR()](/influxdb/v0.13/query_language/functions/#floor)
| [SPREAD()](/influxdb/v0.13/query_language/functions/#spread) | [PERCENTILE()](/influxdb/v0.13/query_language/functions/#percentile) | [HISTOGRAM()](/influxdb/v0.13/query_language/functions/#histogram)
| [SUM()](/influxdb/v0.13/query_language/functions/#sum)  | [TOP()](/influxdb/v0.13/query_language/functions/#top) | [MOVING_AVERAGE()](/influxdb/v0.13/query_language/functions/#moving-average) |
|   |  | [NON_NEGATIVE_DERIVATIVE()](/influxdb/v0.13/query_language/functions/#non-negative-derivative) |
|   |  | [STDDEV()](/influxdb/v0.13/query_language/functions/#stddev)
...
* [Include multiple functions in a single query](/influxdb/v0.13/query_language/functions/#include-multiple-functions-in-a-single-query)
* [Change the value reported for intervals with no data with `fill()` ](/influxdb/v0.13/query_language/functions/#change-the-value-reported-for-intervals-with-no-data-with-fill)
* [Rename the output column's title with `AS`](/influxdb/v0.13/query_language/functions/#rename-the-output-column-s-title-with-as)
...
The examples in this document use the same sample data as the [Data Exploration](/influxdb/v0.13/query_language/data_exploration/) page.
The data are described and are available for download on the [Sample Data](/influxdb/v0.13/sample_data/data_download/) page.

# Aggregations

## COUNT()
Returns the number of non-null values in a single [field](/influxdb/v0.13/concepts/glossary/#field).
```sql
...
> For a more general discussion of `fill()`, see [Data Exploration](/influxdb/v0.13/query_language/data_exploration/#the-group-by-clause-and-fill).

## DISTINCT()
Returns the unique values of a single [field](/influxdb/v0.13/concepts/glossary/#field).
```sql
...
## MEDIAN()
Returns the middle value from the sorted values in a single [field](/influxdb/v0.13/concepts/glossary/#field).
...
> **Note:** `MEDIAN()` is nearly equivalent to [`PERCENTILE(field_key, 50)`](/influxdb/v0.13/query_language/functions/#percentile), except `MEDIAN()` returns the average of the two middle values if the field contains an even number of points.
...
## SUM()
Returns the sum of the all values in a single [field](/influxdb/v0.13/concepts/glossary/#field).
The field must be of type int64 or float64.
```sql
...
## BOTTOM()
Returns the smallest `N` values in a single [field](/influxdb/v0.13/concepts/glossary/#field).
The field type must be int64 or float64.
```sql
...
## FIRST()
Returns the oldest value (determined by the timestamp) of a single [field](/influxdb/v0.13/concepts/glossary/#field).
```sql
...
## LAST()
Returns the newest value (determined by the timestamp) of a single [field](/influxdb/v0.13/concepts/glossary/#field).
```sql
...
See [Frequently Encountered Issues](/influxdb/v0.13/troubleshooting/frequently_encountered_issues/#querying-after-now) for how to query after `now()`.
...
## PERCENTILE()
Returns the `N`th percentile value for the sorted values of a single [field](/influxdb/v0.13/concepts/glossary/#field).
The field must be of type int64 or float64.
...
## TOP()
Returns the largest `N` values in a single [field](/influxdb/v0.13/concepts/glossary/#field).
The field type must be int64 or float64.
```sql
...
## DIFFERENCE()
Returns the difference between consecutive chronological values in a single [field](/influxdb/v0.13/concepts/glossary/#field).
The field type must be int64 or float64.
...
[`COUNT()`](/influxdb/v0.13/query_language/functions/#count),
[`MEAN()`](/influxdb/v0.13/query_language/functions/#mean),
[`MEDIAN()`](/influxdb/v0.13/query_language/functions/#median),
[`SUM()`](/influxdb/v0.13/query_language/functions/#sum),
[`FIRST()`](/influxdb/v0.13/query_language/functions/#first),
[`LAST()`](/influxdb/v0.13/query_language/functions/#last),
[`MIN()`](/influxdb/v0.13/query_language/functions/#min),
[`MAX()`](/influxdb/v0.13/query_language/functions/#max), and
[`PERCENTILE()`](/influxdb/v0.13/query_language/functions/#percentile).
...
[field](/influxdb/v0.13/concepts/glossary/#field).
...
Returns the non-negative rate of change for the values in a single [field](/influxdb/v0.13/concepts/glossary/#field) in a [series](/influxdb/v0.13/concepts/glossary/#series).
InfluxDB calculates the difference between chronological field values and converts those results into the rate of change per `unit`.
The `unit` argument is optional and, if not specified, defaults to one second (`1s`).
...
See [`DERIVATIVE()`](/influxdb/v0.13/query_language/functions/#derivative) for example queries.
...
## STDDEV()
Returns the standard deviation of the values in a single [field](/influxdb/v0.13/concepts/glossary/#field).
The field must be of type int64 or float64.
```sql
...
Calculate the [minimum](/influxdb/v0.13/query_language/functions/#min) `water_level` and the [maximum](/influxdb/v0.13/query_language/functions/#max) `water_level` with a single query:
```sql
...
For a complete discussion of `fill()`, see [Data Exploration](/influxdb/v0.13/query_language/data_exploration/#the-group-by-clause-and-fill).

> **Note:** `fill()` works differently with `COUNT()`.
See [the documentation on `COUNT()`](/influxdb/v0.13/query_language/functions/#count-and-controlling-the-values-reported-for-intervals-with-no-data) for a function-specific use of `fill()`.
