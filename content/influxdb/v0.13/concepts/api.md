...
| Verb  | Query Type |
| :---- | :--------- |
| GET   | Use for all queries that start with: <br><br> [`SELECT`](/influxdb/v0.13/query_language/spec/#select)* <br><br> [`SHOW`](/influxdb/v0.13/query_language/spec/#show-continuous-queries)   |
| POST  | Use for all queries that start with: <br><br> [`ALTER`](/influxdb/v0.13/query_language/spec/#alter-retention-policy) <br><br> [`CREATE`](/influxdb/v0.13/query_language/spec/#create-continuous-query) <br><br> [`DELETE`](/influxdb/v0.13/query_language/spec/#delete) <br><br> [`DROP`](/influxdb/v0.13/query_language/spec/#drop-continuous-query) <br><br> [`GRANT`](/influxdb/v0.13/query_language/spec/#grant) <br><br> [`KILL`](/influxdb/v0.13/query_language/spec/#kill-query) <br><br> [`REVOKE`](/influxdb/v0.13/query_language/spec/#revoke) |

\* The only exceptions are `SELECT` queries that include an [`INTO` clause](/influxdb/v0.13/query_language/data_exploration/#the-into-clause).
...
| db=\<database_name> | Required for database-dependent queries (most [`SELECT`](/influxdb/v0.13/query_language/spec/#select) queries and [`SHOW`](/influxdb/v0.13/query_language/spec/#show-continuous-queries) queries require this parameter). | Sets the target [database](/influxdb/v0.13/concepts/glossary/#database) for the query. |
