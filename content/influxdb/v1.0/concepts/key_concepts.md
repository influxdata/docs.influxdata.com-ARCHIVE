...
<table style="width:100%">
  <tr>
    <td><a href="/influxdb/v1.0/concepts/key_concepts/#database">database</a></td>
    <td><a href="/influxdb/v1.0/concepts/key_concepts/#field-key">field key</a></td>
    <td><a href="/influxdb/v1.0/concepts/key_concepts/#field-set">field set</a></td>
  </tr>
  <tr>
...
Check out the [Glossary](/influxdb/v1.0/concepts/glossary/) if you prefer the cold, hard facts.
...
If you're just starting out, we recommend taking a look at [Getting Started](/influxdb/v1.0/introduction/getting_started/) and the [Writing Data](/influxdb/v1.0/guides/writing_data/) and [Querying Data](/influxdb/v1.0/guides/querying_data/) guides.
