...
Related entries:
[database](/influxdb/v1.0/concepts/glossary/#database),
[field key](/influxdb/v1.0/concepts/glossary/#field-key),
...
[user](/influxdb/v1.0/concepts/glossary/#user)
...
For how to specify time when writing data, see [Write Syntax](/influxdb/v1.0/write_protocols/line_protocol_reference/).
