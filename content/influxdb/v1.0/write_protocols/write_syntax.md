...
A different precision can be specified, see the [HTTP syntax](/influxdb/v1.0/write_protocols/write_syntax/#http) for details.
...
When InfluxDB encounters a duplicate point, the [field set](/influxdb/v1.0/concepts/glossary/#field-set) becomes the union of the old field set and the new field set, where any ties go to the new field set.
...
Keywords in InfluxDB are referenced on the [InfluxQL Syntax](/influxdb/v1.0/query_language/spec/#keywords) page.
...
See [InfluxDB CLI/Shell](/influxdb/v1.0/tools/shell/#import-data-from-a-file-with-import) for how to import data from a file using the CLI.
