...
There are many ways to write data into InfluxDB including the [command line interface](/influxdb/v1.0/tools/shell/), [client libraries](/influxdb/v1.0/tools/api/) and plugins for common data formats such as **Graphite**.
...
The data in the file should follow InfluxDB's [line protocol syntax](/influxdb/v1.0/write_protocols/line_protocol_reference/).
