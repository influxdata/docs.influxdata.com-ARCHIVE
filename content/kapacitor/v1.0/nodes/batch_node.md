...
aliases:
    - /kapacitor/v1.0/tick/batch_node/
menu:
  kapacitor_1_0:
    name: Batch
...
can further be configured. See [QueryNode](/kapacitor/v1.0/nodes/query_node/)
The `batch` variable in batch tasks is an instance of
a [BatchNode.](/kapacitor/v1.0/nodes/batch_node/)
...
-	[Deadman](/kapacitor/v1.0/nodes/batch_node/#deadman)
-	[Query](/kapacitor/v1.0/nodes/batch_node/#query)
-	[Stats](/kapacitor/v1.0/nodes/batch_node/#stats)
...
Returns: [QueryNode](/kapacitor/v1.0/nodes/query_node/)
