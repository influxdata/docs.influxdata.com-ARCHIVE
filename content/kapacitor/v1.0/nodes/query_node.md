...
A [QueryNode](/kapacitor/v1.0/nodes/query_node/) defines a source and a schedule for 
...
-	[Align](/kapacitor/v1.0/nodes/query_node/#align)
-	[Cluster](/kapacitor/v1.0/nodes/query_node/#cluster)
-	[Cron](/kapacitor/v1.0/nodes/query_node/#cron)
...
-	[Alert](/kapacitor/v1.0/nodes/query_node/#alert)
-	[Bottom](/kapacitor/v1.0/nodes/query_node/#bottom)
-	[Combine](/kapacitor/v1.0/nodes/query_node/#combine)
...
-	[Difference](/kapacitor/v1.0/nodes/query_node/#difference)
-	[Distinct](/kapacitor/v1.0/nodes/query_node/#distinct)
-	[Elapsed](/kapacitor/v1.0/nodes/query_node/#elapsed)
-	[Eval](/kapacitor/v1.0/nodes/query_node/#eval)
-	[First](/kapacitor/v1.0/nodes/query_node/#first)
-	[Flatten](/kapacitor/v1.0/nodes/query_node/#flatten)
-	[HoltWinters](/kapacitor/v1.0/nodes/query_node/#holtwinters)
-	[HoltWintersWithFit](/kapacitor/v1.0/nodes/query_node/#holtwinterswithfit)
-	[HttpOut](/kapacitor/v1.0/nodes/query_node/#httpout)
-	[InfluxDBOut](/kapacitor/v1.0/nodes/query_node/#influxdbout)
-	[Join](/kapacitor/v1.0/nodes/query_node/#join)
-	[Last](/kapacitor/v1.0/nodes/query_node/#last)
-	[Log](/kapacitor/v1.0/nodes/query_node/#log)
-	[Max](/kapacitor/v1.0/nodes/query_node/#max)
-	[Mean](/kapacitor/v1.0/nodes/query_node/#mean)
-	[Median](/kapacitor/v1.0/nodes/query_node/#median)
-	[Min](/kapacitor/v1.0/nodes/query_node/#min)
-	[Mode](/kapacitor/v1.0/nodes/query_node/#mode)
-	[MovingAverage](/kapacitor/v1.0/nodes/query_node/#movingaverage)
-	[Percentile](/kapacitor/v1.0/nodes/query_node/#percentile)
-	[Sample](/kapacitor/v1.0/nodes/query_node/#sample)
-	[Shift](/kapacitor/v1.0/nodes/query_node/#shift)
-	[Spread](/kapacitor/v1.0/nodes/query_node/#spread)
-	[Stats](/kapacitor/v1.0/nodes/query_node/#stats)
-	[Stddev](/kapacitor/v1.0/nodes/query_node/#stddev)
-	[Sum](/kapacitor/v1.0/nodes/query_node/#sum)
-	[Top](/kapacitor/v1.0/nodes/query_node/#top)
-	[Union](/kapacitor/v1.0/nodes/query_node/#union)
-	[Where](/kapacitor/v1.0/nodes/query_node/#where)
-	[Window](/kapacitor/v1.0/nodes/query_node/#window)
...
Align start and stop times for quiries with even boundaries of the [QueryNode.Every](/kapacitor/v1.0/nodes/query_node/#every) property. 
Does not apply if using the [QueryNode.Cron](/kapacitor/v1.0/nodes/query_node/#cron) property. 
...
It is recommended to use [QueryNode.Align](/kapacitor/v1.0/nodes/query_node/#align) and [QueryNode.Offset](/kapacitor/v1.0/nodes/query_node/#offset) in conjunction with 
group by time dimensions so that the time bounds match up with the group by intervals. 

NOTE: Since [QueryNode.Offset](/kapacitor/v1.0/nodes/query_node/#offset) is inherently a negative property the second &#34;offset&#34; argument to the &#34;time&#34; function is negative to match. 
