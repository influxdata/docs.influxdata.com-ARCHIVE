...
A [StreamNode](/kapacitor/v1.0/nodes/stream_node/) represents the source of data being 
streamed to Kapacitor via any of its inputs. 
The `stream` variable in stream tasks is an instance of 
a [StreamNode.](/kapacitor/v1.0/nodes/stream_node/) 
[StreamNode.From](/kapacitor/v1.0/nodes/stream_node/#from) is the method/property of this node. 
...
-	[Deadman](/kapacitor/v1.0/nodes/stream_node/#deadman)
-	[From](/kapacitor/v1.0/nodes/stream_node/#from)
-	[Stats](/kapacitor/v1.0/nodes/stream_node/#stats)
...
Creates a new [FromNode](/kapacitor/v1.0/nodes/from_node/) that can be further 
