...
In [another example](/kapacitor/v1.0b/examples/anomaly_detection/) we saw how to write a process based UDF for custom anomaly detection workloads.
...
* Modify the mirror UDF, to function like the [DefaultNode](https://docs.influxdata.com/kapacitor/v1.0b/nodes/default_node/).
