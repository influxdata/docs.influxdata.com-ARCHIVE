...
Install [Kapacitor](/kapacitor/v1.0b/introduction/installation/),
...
Kapacitor uses a DSL called [TICKscript](/kapacitor/v1.0b/tick/) to define tasks.
...
For more information on how the alerting works, see the [AlertNode](/kapacitor/v1.0b/nodes/alert_node/) docs.
...
Take a look at the [examples](/kapacitor/v1.0b/examples/) page for more guides on how to use Kapacitor.
