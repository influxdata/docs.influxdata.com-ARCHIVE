...
An [AlertNode](/kapacitor/v1.0b/nodes/alert_node/) can trigger an event of varying severity levels, 
...
See [AlertNode.Info,](/kapacitor/v1.0b/nodes/alert_node/#info) [AlertNode.Warn,](/kapacitor/v1.0b/nodes/alert_node/#warn) and [AlertNode.Crit](/kapacitor/v1.0b/nodes/alert_node/#crit) below. 

Different event handlers can be configured for each [AlertNode.](/kapacitor/v1.0b/nodes/alert_node/) 
...
Using the [AlertNode.StateChangesOnly](/kapacitor/v1.0b/nodes/alert_node/#statechangesonly) property events will only be sent to handlers 
...
-	[Alerta](/kapacitor/v1.0b/nodes/alert_node/#alerta)
-	[All](/kapacitor/v1.0b/nodes/alert_node/#all)
-	[Crit](/kapacitor/v1.0b/nodes/alert_node/#crit)
-	[Details](/kapacitor/v1.0b/nodes/alert_node/#details)
-	[DurationField](/kapacitor/v1.0b/nodes/alert_node/#durationfield)
-	[Email](/kapacitor/v1.0b/nodes/alert_node/#email)
-	[Exec](/kapacitor/v1.0b/nodes/alert_node/#exec)
-	[Flapping](/kapacitor/v1.0b/nodes/alert_node/#flapping)
-	[HipChat](/kapacitor/v1.0b/nodes/alert_node/#hipchat)
-	[History](/kapacitor/v1.0b/nodes/alert_node/#history)
-	[Id](/kapacitor/v1.0b/nodes/alert_node/#id)
-	[IdField](/kapacitor/v1.0b/nodes/alert_node/#idfield)
-	[IdTag](/kapacitor/v1.0b/nodes/alert_node/#idtag)
-	[Info](/kapacitor/v1.0b/nodes/alert_node/#info)
-	[LevelField](/kapacitor/v1.0b/nodes/alert_node/#levelfield)
-	[LevelTag](/kapacitor/v1.0b/nodes/alert_node/#leveltag)
-	[Log](/kapacitor/v1.0b/nodes/alert_node/#log)
-	[Message](/kapacitor/v1.0b/nodes/alert_node/#message)
-	[OpsGenie](/kapacitor/v1.0b/nodes/alert_node/#opsgenie)
-	[PagerDuty](/kapacitor/v1.0b/nodes/alert_node/#pagerduty)
-	[Post](/kapacitor/v1.0b/nodes/alert_node/#post)
-	[Sensu](/kapacitor/v1.0b/nodes/alert_node/#sensu)
-	[Slack](/kapacitor/v1.0b/nodes/alert_node/#slack)
-	[StateChangesOnly](/kapacitor/v1.0b/nodes/alert_node/#statechangesonly)
-	[Talk](/kapacitor/v1.0b/nodes/alert_node/#talk)
-	[VictorOps](/kapacitor/v1.0b/nodes/alert_node/#victorops)
-	[Warn](/kapacitor/v1.0b/nodes/alert_node/#warn)

### Chaining Methods

-	[Alert](/kapacitor/v1.0b/nodes/alert_node/#alert)
-	[Bottom](/kapacitor/v1.0b/nodes/alert_node/#bottom)
-	[Count](/kapacitor/v1.0b/nodes/alert_node/#count)
-	[Deadman](/kapacitor/v1.0b/nodes/alert_node/#deadman)
-	[Default](/kapacitor/v1.0b/nodes/alert_node/#default)
-	[Derivative](/kapacitor/v1.0b/nodes/alert_node/#derivative)
-	[Distinct](/kapacitor/v1.0b/nodes/alert_node/#distinct)
-	[Elapsed](/kapacitor/v1.0b/nodes/alert_node/#elapsed)
-	[Eval](/kapacitor/v1.0b/nodes/alert_node/#eval)
-	[First](/kapacitor/v1.0b/nodes/alert_node/#first)
-	[GroupBy](/kapacitor/v1.0b/nodes/alert_node/#groupby)
-	[HoltWinters](/kapacitor/v1.0b/nodes/alert_node/#holtwinters)
-	[HoltWintersWithFit](/kapacitor/v1.0b/nodes/alert_node/#holtwinterswithfit)
-	[HttpOut](/kapacitor/v1.0b/nodes/alert_node/#httpout)
-	[InfluxDBOut](/kapacitor/v1.0b/nodes/alert_node/#influxdbout)
-	[Join](/kapacitor/v1.0b/nodes/alert_node/#join)
-	[Last](/kapacitor/v1.0b/nodes/alert_node/#last)
-	[Max](/kapacitor/v1.0b/nodes/alert_node/#max)
-	[Mean](/kapacitor/v1.0b/nodes/alert_node/#mean)
-	[Median](/kapacitor/v1.0b/nodes/alert_node/#median)
-	[Min](/kapacitor/v1.0b/nodes/alert_node/#min)
-	[Percentile](/kapacitor/v1.0b/nodes/alert_node/#percentile)
-	[Sample](/kapacitor/v1.0b/nodes/alert_node/#sample)
-	[Shift](/kapacitor/v1.0b/nodes/alert_node/#shift)
-	[Spread](/kapacitor/v1.0b/nodes/alert_node/#spread)
-	[Stats](/kapacitor/v1.0b/nodes/alert_node/#stats)
-	[Stddev](/kapacitor/v1.0b/nodes/alert_node/#stddev)
-	[Sum](/kapacitor/v1.0b/nodes/alert_node/#sum)
-	[Top](/kapacitor/v1.0b/nodes/alert_node/#top)
-	[Union](/kapacitor/v1.0b/nodes/alert_node/#union)
-	[Where](/kapacitor/v1.0b/nodes/alert_node/#where)
-	[Window](/kapacitor/v1.0b/nodes/alert_node/#window)
...
use [AlertNode.StateChangesOnly](/kapacitor/v1.0b/nodes/alert_node/#statechangesonly) so that only events 
...
Alerta environment. 
Can be a template and has access to the same data as the [AlertNode.Details](/kapacitor/v1.0b/nodes/alert_node/#details) property. 
...
The same template data is available as the [AlertNode.Message](/kapacitor/v1.0b/nodes/alert_node/#message) property, 
...
The email subject is the [AlertNode.Message](/kapacitor/v1.0b/nodes/alert_node/#message) property. 
The email body is the [AlertNode.Details](/kapacitor/v1.0b/nodes/alert_node/#details) property. 
