...
For step-by-step instructions on setting up Kapacitor with Telegram, see the Event Handler Setup Guide (//kapacitor/latest/guides/event-handler-setup/#telegram-setup).
