...
For instructions on upgrading InfluxDB, please see the [InfluxDB upgrade](/{{< latest "influxdb" >}}/administration/upgrading/#main-nav) documentation. For instructions on upgrading Telegraf, please see the [Telegraf upgrade](/telegraf/v1.3/administration/upgrading/) documentation.
