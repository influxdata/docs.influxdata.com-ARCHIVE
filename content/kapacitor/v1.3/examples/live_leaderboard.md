...
**If you do not have a running Kapacitor instance check out the [getting started guide](/kapacitor/v1.2/introduction/getting_started/)
...
Our [TICKscript](/kapacitor/v1.2/tick/) will look like this:
...
Kapacitor can expose the scores over HTTP via the [HTTPOutNode](/kapacitor/v1.2/nodes/http_out_node/).
