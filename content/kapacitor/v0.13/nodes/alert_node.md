...
An [AlertNode](/kapacitor/v0.13/nodes/alert_node/) can trigger an event of varying severity levels,
and pass the event to alert handlers. The criteria for triggering
an alert is specified via a [lambda expression](/kapacitor/v0.13/tick/expr/).
See [AlertNode.Info,](/kapacitor/v0.13/nodes/alert_node/#info) [AlertNode.Warn,](/kapacitor/v0.13/nodes/alert_node/#warn) and [AlertNode.Crit](/kapacitor/v0.13/nodes/alert_node/#crit) below.

Different event handlers can be configured for each [AlertNode.](/kapacitor/v0.13/nodes/alert_node/)
...
Using the [AlertNode.StateChangesOnly](/kapacitor/v0.13/nodes/alert_node/#statechangesonly) property events will only be sent to handlers
...
-	[Alerta](/kapacitor/v0.13/nodes/alert_node/#alerta)
-	[All](/kapacitor/v0.13/nodes/alert_node/#all)
-	[Crit](/kapacitor/v0.13/nodes/alert_node/#crit)
-	[Details](/kapacitor/v0.13/nodes/alert_node/#details)
-	[DurationField](/kapacitor/v0.13/nodes/alert_node/#durationfield)
-	[Email](/kapacitor/v0.13/nodes/alert_node/#email)
-	[Exec](/kapacitor/v0.13/nodes/alert_node/#exec)
-	[Flapping](/kapacitor/v0.13/nodes/alert_node/#flapping)
-	[HipChat](/kapacitor/v0.13/nodes/alert_node/#hipchat)
-	[History](/kapacitor/v0.13/nodes/alert_node/#history)
-	[Id](/kapacitor/v0.13/nodes/alert_node/#id)
-	[IdField](/kapacitor/v0.13/nodes/alert_node/#idfield)
-	[IdTag](/kapacitor/v0.13/nodes/alert_node/#idtag)
-	[Info](/kapacitor/v0.13/nodes/alert_node/#info)
-	[LevelField](/kapacitor/v0.13/nodes/alert_node/#levelfield)
-	[LevelTag](/kapacitor/v0.13/nodes/alert_node/#leveltag)
-	[Log](/kapacitor/v0.13/nodes/alert_node/#log)
-	[Message](/kapacitor/v0.13/nodes/alert_node/#message)
-	[OpsGenie](/kapacitor/v0.13/nodes/alert_node/#opsgenie)
-	[PagerDuty](/kapacitor/v0.13/nodes/alert_node/#pagerduty)
-	[Post](/kapacitor/v0.13/nodes/alert_node/#post)
-	[Sensu](/kapacitor/v0.13/nodes/alert_node/#sensu)
-	[Slack](/kapacitor/v0.13/nodes/alert_node/#slack)
-	[StateChangesOnly](/kapacitor/v0.13/nodes/alert_node/#statechangesonly)
-	[Talk](/kapacitor/v0.13/nodes/alert_node/#talk)
-	[VictorOps](/kapacitor/v0.13/nodes/alert_node/#victorops)
-	[Warn](/kapacitor/v0.13/nodes/alert_node/#warn)

### Chaining Methods

-	[Alert](/kapacitor/v0.13/nodes/alert_node/#alert)
-	[Bottom](/kapacitor/v0.13/nodes/alert_node/#bottom)
-	[Count](/kapacitor/v0.13/nodes/alert_node/#count)
-	[Deadman](/kapacitor/v0.13/nodes/alert_node/#deadman)
-	[Default](/kapacitor/v0.13/nodes/alert_node/#default)
-	[Derivative](/kapacitor/v0.13/nodes/alert_node/#derivative)
-	[Distinct](/kapacitor/v0.13/nodes/alert_node/#distinct)
-	[Elapsed](/kapacitor/v0.13/nodes/alert_node/#elapsed)
-	[Eval](/kapacitor/v0.13/nodes/alert_node/#eval)
-	[First](/kapacitor/v0.13/nodes/alert_node/#first)
-	[GroupBy](/kapacitor/v0.13/nodes/alert_node/#groupby)
-	[HttpOut](/kapacitor/v0.13/nodes/alert_node/#httpout)
-	[InfluxDBOut](/kapacitor/v0.13/nodes/alert_node/#influxdbout)
-	[Join](/kapacitor/v0.13/nodes/alert_node/#join)
-	[Last](/kapacitor/v0.13/nodes/alert_node/#last)
-	[Max](/kapacitor/v0.13/nodes/alert_node/#max)
-	[Mean](/kapacitor/v0.13/nodes/alert_node/#mean)
-	[Median](/kapacitor/v0.13/nodes/alert_node/#median)
-	[Min](/kapacitor/v0.13/nodes/alert_node/#min)
-	[Percentile](/kapacitor/v0.13/nodes/alert_node/#percentile)
-	[Sample](/kapacitor/v0.13/nodes/alert_node/#sample)
-	[Shift](/kapacitor/v0.13/nodes/alert_node/#shift)
-	[Spread](/kapacitor/v0.13/nodes/alert_node/#spread)
-	[Stats](/kapacitor/v0.13/nodes/alert_node/#stats)
-	[Stddev](/kapacitor/v0.13/nodes/alert_node/#stddev)
-	[Sum](/kapacitor/v0.13/nodes/alert_node/#sum)
-	[Top](/kapacitor/v0.13/nodes/alert_node/#top)
-	[Union](/kapacitor/v0.13/nodes/alert_node/#union)
-	[Where](/kapacitor/v0.13/nodes/alert_node/#where)
-	[Window](/kapacitor/v0.13/nodes/alert_node/#window)
...
use [AlertNode.StateChangesOnly](/kapacitor/v0.13/nodes/alert_node/#statechangesonly) so that only events
...
Alerta environment.
Can be a template and has access to the same data as the [AlertNode.Details](/kapacitor/v0.13/nodes/alert_node/#details) property.
...
The same template data is available as the [AlertNode.Message](/kapacitor/v0.13/nodes/alert_node/#message) property,
...
The email subject is the [AlertNode.Message](/kapacitor/v0.13/nodes/alert_node/#message) property.
The email body is the [AlertNode.Details](/kapacitor/v0.13/nodes/alert_node/#details) property.
