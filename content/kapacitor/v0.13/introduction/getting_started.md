...
Install [Kapacitor](/kapacitor/v0.13/introduction/installation/),
...
Kapacitor uses a DSL called [TICKscript](/kapacitor/v0.13/tick/) to define tasks.
...
For more information on how the alerting works, see the [AlertNode](/kapacitor/v0.13/nodes/alert_node/) docs.
...
Take a look at the [examples](/kapacitor/v0.13/examples/) page for more guides on how to use Kapacitor.
