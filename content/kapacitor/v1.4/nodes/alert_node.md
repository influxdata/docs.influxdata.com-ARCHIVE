...
description: A Kapacitor AlertNode triggers an event of varying severity levels,
and passes the event to alert handlers. The criteria for triggering an alert is specified using a lambda expression.
