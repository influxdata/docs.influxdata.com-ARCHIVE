---
title: AlertNode
description: A Kapacitor AlertNode can be used in TICKscripts to trigger an event of varying severity levels,
and pass the event to alert handlers. The criteria for triggering an alert is specified using a lambda expression.
