...
description: UnionNode takes the union of all of its parents. The union is just a simple pass through. Data points received from each parent are passed to children nodes without modification.
