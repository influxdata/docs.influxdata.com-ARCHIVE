...
description: EC2AutoscaleNode triggers autoscale events for a group on an AWS Autoscaling group.
...
EC2AutoscaleNode triggers autoscale events for a group on an AWS Autoscaling group.
The node also outputs points for the triggered events.
