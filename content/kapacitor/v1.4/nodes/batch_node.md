---
title: BatchNode
description: A Kapacitor BatchNode handles creating several child QueryNodes. Each call to `query` creates a child batch node that
can further be configured. The `batch` variable in batch tasks is an instance of BatchNode.
