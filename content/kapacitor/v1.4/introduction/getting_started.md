...
* [Telegraf](/telegraf/v1.4/) - Telegraf >= 1.4.x will be required.
* [Kapacitor](/kapacitor/v1.4/) - The latest Kapacitor binary and installation packages for most OSes can be found at the [downloads](https://influxdata.com/downloads/#kapacitor) page.
