...
**If you do not have a running Kapacitor instance check out the [getting started guide](/kapacitor/v0.1/introduction/getting_started/)
...
Our [TICKscript](/kapacitor/v0.1/tick/) will look like this:
...
Kapacitor can expose the scores over HTTP via the [HTTPOutNode](/kapacitor/v0.1/tick/http_out_node/).
