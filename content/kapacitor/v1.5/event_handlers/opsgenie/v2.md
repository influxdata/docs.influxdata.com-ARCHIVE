...
> This doc is specific to OpsGenie's v2 API. If still using their v1 API, view
> the [OpsGenie v1 event handler](../v1/) documentation.
...
alerts to OpsGenie or define a OpsGenie v2 handler that subscribes to a topic
