...
aliases:
  - /kapacitor/v0.10/tick/source_batch_node/
...
can further be configured. See [BatchNode](/kapacitor/v0.10/nodes/batch_node/) 
The `batch` variable in batch tasks is an instance of 
a [SourceBatchNode.](/kapacitor/v0.10/nodes/source_batch_node/) 
...
Returns: [BatchNode](/kapacitor/v0.10/nodes/batch_node/)
