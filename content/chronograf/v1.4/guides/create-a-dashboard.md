...
Use Chronograf's [pre-created dashboards](/chronograf/v1.4/guides/using-precreated-dashboards) or create custom dashboards to meet your requirements.
...
For more information, see [Configuring Chronograf](/chronograf/v1.4/administration/configuration).
...
Chronograf supports many different [visualization types](/chronograf/v1.4/guides/visualization-types/). To choose a visualization type, click **Visualization** and select **Step-Plot Graph**.
