...
Those settings are configurable; see the [configuration file](/chronograf/v1.1/administration/configuration/) to change them and to see the other configuration options.
...
3.
Choose the server, [database](/influxdb/v1.1/concepts/glossary/#database), and [retention policy](/influxdb/v1.1/concepts/glossary/#retention-policy-rp) that you want to work with:
<br>
<br>
...
To create a [query](/influxdb/v1.1/concepts/glossary/#query), you can either use the Query Builder or, if you're already familiar with InfluxQL, you can manually enter the query in the text input.
...
<br>
<br>
![Select Graph For Dash](/img/chronograf/v1.1/select-graph-for-dash.png)
