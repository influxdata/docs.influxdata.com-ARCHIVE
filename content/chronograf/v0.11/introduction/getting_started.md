...
3.
Choose the server, [database](/influxdb/v0.11/concepts/glossary/#database), and [retention policy](/influxdb/v0.11/concepts/glossary/#retention-policy-rp) that you want to work with:
<br>
<br>
