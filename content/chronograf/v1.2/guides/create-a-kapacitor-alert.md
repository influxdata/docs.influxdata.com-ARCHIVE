...
The steps below also assume that you've already [configured your Kapacitor instance in Chronograf](/chronograf/v1.2/introduction/getting-started/#4-connect-chronograf-to-kapacitor).
The [Getting Started](/chronograf/v1.2/introduction/getting-started/) guide offers step-by-step instructions for each of those requirements.

The steps below also assume that you have a working Slack instance and that you've configured it as an [event handler](/chronograf/v1.2/troubleshooting/frequently-asked-questions/#what-kapacitor-event-handlers-are-supported-in-chronograf) in Chronograf.
See the [Configure Kapacitor Event Handlers](/chronograf/v1.2/guides/configure-kapacitor-event-handlers/) guide for detailed configuration instructions.
...
![Navigate to Rule Configuration](/img/chronograf/v1.2/g-kap-rule-page.png)
...
![Empty Rule Configuration](/img/chronograf/v1.2/g-kap-blank-rule.png)
...
![Name your rule](/img/chronograf/v1.2/g-kap-rule-name.png)
...
![Select your data](/img/chronograf/v1.2/g-kap-ts.png)
...
![Create a condition](/img/chronograf/v1.2/g-kap-condition.png)
...
![Change the time range](/img/chronograf/v1.2/g-kap-timerange.gif)
...
Chronograf supports several [event handlers](/chronograf/v1.2/troubleshooting/frequently-asked-questions/#what-kapacitor-event-handlers-are-supported-in-chronograf).
...
![Specify event handler and alert message](/img/chronograf/v1.2/g-kap-alertmessage.png)

> **Note:**
There's no need to include a Slack channel in the `Alert Message` section if you specified a default channel in the [initial Slack configuration](/chronograf/v1.2/guides/configure-kapacitor-event-handlers/).
...
![See the alert rule](/img/chronograf/v1.2/g-kap-rule-page-ii.png)
...
![See the alerts](/img/chronograf/v1.2/g-kap-slack.png)
