...
>
> For information about the new user roles and SuperAdmin status, see [Managing Chronograf users](/chronograf/v1.5/administration/managing-chronograf-users/).
...
* [Managing security](/chronograf/v1.5/administration/managing-security/)
