...
Use Chronograf's [pre-created dashboards](/chronograf/v1.5/guides/using-precreated-dashboards) or create custom dashboards to meet your requirements.
...
![Oh, the Chronobilities](/img/(/chronograf/v1.5/g-dashboard-possibilities.png)
...
For more information, see [Configuring Chronograf](/chronograf/v1.5/administration/configuration).
...
Click the **Add a Query** button to create an [InfluxQL](/{{< latest "influxdb" >}}/query_language/) query.
...
By default, Chronograf applies the [`MEAN()` function](/{{< latest "influxdb" >}}/query_language/functions/#mean) to the data, groups averages into auto-generated time intervals (`:interval:`), and shows data for the past hour (`:dashboardTime:`).
...
Chronograf supports many different [visualization types](/chronograf/v1.5/guides/visualization-types/). To choose a visualization type, click **Visualization** and select **Step-Plot Graph**.
...
> Note:
These tips only apply to the line, stacked, step-plot, and line+stat [visualization types](/chronograf/v1.5/troubleshooting/frequently-asked-questions/#what-visualization-types-does-chronograf-support).
...
See the [Dashboard Template Variables](/chronograf/v1.5/guides/dashboard-template-variables/) guide for more information.
