...
aliases:
    ...
    - /(/chronograf/v1.5/introduction/getting_started/
menu:
  chronograf_1_5:
...
![Getting started setup](/img/(/chronograf/v1.5/intro-gs-diagram.png)
...
For a complete list of the installation requirements, see the [Installation](/chronograf/v1.5/introduction/installation/) page.

## InfluxDB Setup

[InfluxDB](/{{< latest "influxdb" >}}/) is the time series database that serves as the data storage component of the TICK stack.
...
![Chronograf Welcome Page](/img/(/chronograf/v1.5/welcome-page.png)
...
![Chronograf Host List Page](/img/(/chronograf/v1.5/gs-host-list.png)
...
![System Stats Graphs](/img/(/chronograf/v1.5/gs-system-dashboard.png)
...
![Configure Kapacitor](/img/(/chronograf/v1.5/gs-configure-kapacitor.png)
...
Kapacitor supports several [alert endpoints/event handlers](/chronograf/v1.5/troubleshooting/frequently-asked-questions/#what-kapacitor-event-handlers-are-supported-in-chronograf).
See the [Configuring Chronograf alert endpoints](/chronograf/v1.5/guides/configuring-alert-endpoints/) guide for more information.
...
Next, check out [our guides](/chronograf/v1.5/guides/) to become familiar with Chronograf and see all that you can do with it!
