...
### UI improvements
  ...
  * [Bar graph](/chronograf/v1.5/troubleshooting/frequently-asked-questions/#bar) option added to dashboard
  * Redesign source management table to be more intuitive
  * Redesign [Line + Single Stat](/chronograf/v1.5/troubleshooting/frequently-asked-questions/#line-stat) cells to appear more like a sparkline, and improve legibility
...
### Bug fixes
  ...
  * Fix infinite spinner when `/chronograf` is a [basepath](/chronograf/v1.5/administration/configuration/#p-basepath)
  ...
  * Allow users to click the add query button after selecting singleStat as the [visualization type](/chronograf/v1.5/troubleshooting/frequently-asked-questions/#what-visualization-types-does-chronograf-support)
  * Add a query for windows uptime - thank you, @brianbaker!

### Features

  * Add log [event handler](/chronograf/v1.5/troubleshooting/frequently-asked-questions/#what-kapacitor-event-handlers-are-supported-in-chronograf) - thank you, @mpchadwick!
  * Update Go (golang) vendoring to dep and committed vendor directory
  * Add autocomplete functionality to [template variable](/chronograf/v1.5/guides/dashboard-template-variables/) dropdowns
...
### UI improvements
  ...
  * Make the [template variables](/chronograf/v1.5/guides/dashboard-template-variables/) manager more space efficient
...
### Bug fixes
  ...
  * Fix the link to home when using the [`--basepath` option](/chronograf/v1.5/administration/configuration/#p-basepath)
  ...
  * Fix Authentication when using Chronograf with a set [basepath](/chronograf/v1.5/administration/configuration/#p-basepath)
  ...
  * Show legend on [Line+Stat](/chronograf/v1.5/troubleshooting/frequently-asked-questions/#line-stat) visualization type
...
### Features
  ...
  * Add support for enabling and disabling [TICKscripts that were created outside Chronograf](/chronograf/v1.5/guides/advanced-kapacitor/#tickscript-management)
