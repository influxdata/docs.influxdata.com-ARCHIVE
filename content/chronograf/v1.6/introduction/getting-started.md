...
> ### System stats on a Windows host
> **If on a Windows host**, the [`win_perf_counters` Telegraf input plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/win_perf_counters)
...
![Chronograf Welcome Page](/img/chronograf/v1.6/welcome-page.png)
...
![Chronograf Host List Page](/img/chronograf/v1.6/gs-host-list.png)
...
![System Stats Graphs](/img/chronograf/v1.6/gs-system-dashboard.png)
...
![Configure Kapacitor](/img/chronograf/v1.6/gs-configure-kapacitor.png)
...
![Alert Endpoints](/img/chronograf/v1.6/gs-alert-endpoints.png)
