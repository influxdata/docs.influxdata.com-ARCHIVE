...
Users who expect to have a large number of alerts and users who do not want to store their alert history forever, may want to shorten the [duration](/{{< latest "influxdb" >}}/concepts/glossary/#duration) of that RP.
