...
<br>
In [cell editor mode](/chronograf/v1.3/guides/create-a-dashboard/#step-2-enter-cell-editor-mode), create an [InfluxQL](/{{< latest "influxdb" >}}/query_language/) query that uses the `:database:` template variable.
...
##### Use the variable in a cell
<br>
In [cell editor mode](/chronograf/v1.3/guides/create-a-dashboard/#step-2-enter-cell-editor-mode), create an [InfluxQL](/{{< latest "influxdb" >}}/query_language/) query that uses the `:measurement:` template variable.
...
##### Use the variable in a cell
<br>
In [cell editor mode](/chronograf/v1.3/guides/create-a-dashboard/#step-2-enter-cell-editor-mode), create an [InfluxQL](/{{< latest "influxdb" >}}/query_language/) query that uses the `:field-key:` template variable.
...
##### Use the variable in a cell
<br>
In [cell editor mode](/chronograf/v1.3/guides/create-a-dashboard/#step-2-enter-cell-editor-mode), create an [InfluxQL](/{{< latest "influxdb" >}}/query_language/) query that uses the `:tag-key:` template variable.
...
##### Use the variable in a cell
<br>
In [cell editor mode](/chronograf/v1.3/guides/create-a-dashboard/#step-2-enter-cell-editor-mode), create an [InfluxQL](/{{< latest "influxdb" >}}/query_language/) query that uses the `:tag-value:` template variable.
The query below selects all `purchases` [values](/{{< latest "influxdb" >}}/concepts/glossary/#field-value) in the `animals` database, the `autogen` [retention policy](/{{< latest "influxdb" >}}/concepts/glossary/#retention-policy-rp), and the `customers` measurement.
...
##### Use the variable in a cell
<br>
In [cell editor mode](/chronograf/v1.3/guides/create-a-dashboard/#step-2-enter-cell-editor-mode), create an [InfluxQL](/{{< latest "influxdb" >}}/query_language/) query that uses the `:field-value:` template variable.
