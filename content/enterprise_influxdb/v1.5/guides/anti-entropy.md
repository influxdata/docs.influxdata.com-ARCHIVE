...
Follow the [Data Node Installation Guide](/enterprise_influxdb/v1.5/production_installation/data_node_installation/) to start the new data node's `influxdb` service, but **do not join the data node to the cluster**.
...
Follow the instructions in the [Data Node Installation Guide](/enterprise_influxdb/v1.5/production_installation/data_node_installation/), but **do not join the data node to the cluster**.
