...
There are [deployment options](/enterprise_influxdb/v1.6/install-and-deploy/deploy/) available to easily install an InfluxDB Enterprise cluster in select environments.
