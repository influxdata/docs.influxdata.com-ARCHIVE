...
To use fine-grained authorization (hereafter "FGA"), you must first [enable authentication](https://docs.influxdata.com/influxdb/v1.3/query_language/authentication_and_authorization/#set-up-authentication) in your configuration file.
