...
The [Anti-Entropy service](/enterprise_influxdb/v1.8/administration/anti-entropy) is used by InfluxDB Enterprise clusters to monitor and repair entropy in data nodes and their shards.
