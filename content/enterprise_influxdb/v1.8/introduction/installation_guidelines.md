...
The [QuickStart installation](/enterprise_influxdb/v1.8/quickstart_installation/) process is intended for users looking to quickly get up and running with InfluxDB Enterprise and for users who want to evaluate it.
The QuickStart installation process **is not** intended for use
in a production environment.

The [Production installation](/enterprise_influxdb/v1.8/production_installation/) process is recommended for users intending to deploy the InfluxDB Enterprise installation in a production environment.
...
There are [other installation options](/enterprise_influxdb/v1.8/install-and-deploy/) available to easily install an InfluxDB Enterprise cluster in select environments.
