...
aliases:
    - /enterprise_influxdb/v1.8/quickstart_installation/cluster_installation/
menu:
...
Each server is a [meta node](/enterprise_influxdb/v1.8/concepts/glossary/#meta-node) and
a [data node](/enterprise_influxdb/v1.8/concepts/glossary/#data-node), that is, each server
runs both the [meta service](/enterprise_influxdb/v1.8/concepts/glossary/#meta-service)
and the [data service](/enterprise_influxdb/v1.8/concepts/glossary/#data-service).
...
4	quickstart-cluster-02:8088	1.8.0-c1.8.0
5	quickstart-cluster-03:8088	1.8.0-c1.8.0

Meta Nodes
==========
TCP Address		Version
quickstart-cluster-01:8091		1.8.0-c1.8.0
quickstart-cluster-02:8091	  1.8.0-c1.8.0
quickstart-cluster-03:8091	  1.8.0-c1.8.0
```
...
Once all of your nodes are joined to the cluster, move on to the [next step](/enterprise_influxdb/v1.8/install-and-deploy/quickstart_installation/chrono_install)
