...
The hostname of the [meta node](/enterprise_influxdb/v1.1/concepts/glossary/#meta-node).
...
The port used by the [`influxd-ctl` tool](/enterprise_influxdb/v1.1/features/cluster-commands/) and by data nodes to access the
meta APIs.
For simplicity we recommend using the same port on all meta nodes, but this
is not necessary.
...
The hostname of the [data node](/enterprise_influxdb/v1.1/concepts/glossary/#data-node).
...
See the [OSS documentation](/influxdb/v1.1/administration/config/#logging-enabled-true).
...
points sent via the
[hinted handoff](/enterprise_influxdb/v1.1/concepts/clustering/#hinted-handoff), but
...
See the [OSS documentation](/influxdb/v1.1/administration/config/#bind-address-8086).
...
[`shared-secret` setting](/enterprise_influxdb/v1.1/administration/configuration/#shared-secret)
...
See
[Step 3 - Web Console Installation](/enterprise_influxdb/v1.1/introduction/web_console_installation/#install-the-influxenterprise-web-console-with-postgresql) for instructions on using PostgreSQL.
