...
## Upgrading InfluxDB Enterprise 1.3.x-1.5.x clusters to 1.7.2 (rolling upgrade)

### Step 0: Back up your cluster before upgrading to version 1.7.2.
...
### Step 1: Download the 1.7.2 meta node package.
...
### Step 2: Install the 1.7.2 meta nodes package.
...
==========
TCP Address		Version
rk-upgrading-01:8091	1.7.2_c1.7.2   # 1.7.2_c1.7.2 = 👍
rk-upgrading-02:8091	1.7.2_c1.7.2
rk-upgrading-03:8091	1.7.2_c1.7.2
```
...
### Step 1: Download the 1.7.2 data node package.
...
### Step 3: Install the 1.7.2 data node packages.

#### Data node package install

When you run the install command, your terminal asks if you want to keep your
current configuration file or overwrite your current configuration file with the file for version 1.7.2.

Keep your current configuration file by entering `N` or `O`.
The configuration file will be updated with the necessary changes for version 1.7.2 in the next step.
...
Your cluster is now upgraded to InfluxDB Enterprise 1.7.2.
...
==========
ID	TCP Address		Version
4	rk-upgrading-01:8088	1.7.2_c1.7.2   # 1.7.2_c1.7.2 = 👍
5	rk-upgrading-02:8088	1.7.2_c1.7.2
6	rk-upgrading-03:8088	1.7.2_c1.7.2

Meta Nodes
==========
TCP Address		Version
rk-upgrading-01:8091	1.7.2_c1.7.2
rk-upgrading-02:8091	1.7.2_c1.7.2
rk-upgrading-03:8091	1.7.2_c1.7.2
```
