...
## Upgrading InfluxDB Enterprise 1.3.x-1.6.x clusters to 1.7.5 (rolling upgrade)

### Step 0: Back up your cluster before upgrading to version 1.7.5.
...
### Step 1: Download the 1.7.5 meta node package
...
### Step 2: Install the 1.7.5 meta nodes package
...
==========
TCP Address		Version
rk-upgrading-01:8091	1.7.5_c1.7.5   # 1.7.5_c1.7.5 = 👍
rk-upgrading-02:8091	1.7.5_c1.7.5
rk-upgrading-03:8091	1.7.5_c1.7.5
```
...
### Step 1: Download the 1.7.5 data node package
...
### Step 3: Install the 1.7.5 data node packages

#### Data node package install

When you run the install command, your terminal asks if you want to keep your
current configuration file or overwrite your current configuration file with the file for version 1.7.5.

Keep your current configuration file by entering `N` or `O`.
The configuration file will be updated with the necessary changes for version 1.7.5 in the next step.
...
Your cluster is now upgraded to InfluxDB Enterprise 1.7.5.
...
==========
ID	TCP Address		Version
4	rk-upgrading-01:8088	1.7.5_c1.7.5   # 1.7.5_c1.7.5 = 👍
5	rk-upgrading-02:8088	1.7.5_c1.7.5
6	rk-upgrading-03:8088	1.7.5_c1.7.5

Meta Nodes
==========
TCP Address		Version
rk-upgrading-01:8091	1.7.5_c1.7.5
rk-upgrading-02:8091	1.7.5_c1.7.5
rk-upgrading-03:8091	1.7.5_c1.7.5
```
