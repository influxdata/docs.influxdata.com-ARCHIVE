...
1. For each data node in the cluster, do the following:
   ...
   c. Restart the influxdb service, and wait for the data node to return to a healthy state (node is up, receiving read
 and write requests, and the hinted handoff queue is drained). 
