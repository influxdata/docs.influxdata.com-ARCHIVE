...
1. In InfluxDB CLI, run the following command, specifying the `shard ID` to copy, the `source TCP address` of the original data node and `destination_TCP_address` of the new data node:
