...
aliases:
    - /enterprise/v1.4/guides/migration/
menu:
...
- [Production Installation of Meta Nodes](/enterprise_influxdb/v1.4/production_installation/meta_node_installation/)
</dt>
...
Increase the [replication factor](/enterprise_influxdb/v1.4/concepts/glossary/#replication-factor)
on all existing retention polices to the number of data nodes in your cluster.
You can do this with [ALTER RETENTION POLICY](https://docs.influxdata.com/influxdb/v1.4/query_language/database_management/#modify-retention-policies-with-alter-retention-policy).

Next, [rebalance](/enterprise_influxdb/v1.4/guides/rebalance/) your cluster manually to meet the desired
