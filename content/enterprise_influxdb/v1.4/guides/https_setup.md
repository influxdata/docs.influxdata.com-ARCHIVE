...
[strongly recommend](/enterprise_influxdb/v1.4/administration/security_best_practices/)
...
Next, verify that HTTPS is working by connecting to InfluxEnterprise with the [CLI tool](/influxdb/v1.4/tools/shell/):
```
...
Connecting [Telegraf](/telegraf/v1.4/) to an InfluxEnterprise instance that's using
