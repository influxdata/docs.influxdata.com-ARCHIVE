...
To use fine-grained authorization (hereafter "FGA"), you must first [enable authentication](/influxdb/v1.4/query_language/authentication_and_authorization/#set-up-authentication) in your configuration file.
...
Users are the same as the users created in InfluxQL, and [roles](/enterprise_influxdb/v1.4/features/users/#cluster-user-information), an Enterprise feature, are created separately through the Meta HTTP API.
