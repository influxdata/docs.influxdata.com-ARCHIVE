...
a [data node](/enterprise_influxdb/v1.4/concepts/glossary/#data-node), that is, each server
runs both the [meta service](/enterprise_influxdb/v1.4/concepts/glossary/#meta-service)
and the [data service](/enterprise_influxdb/v1.4/concepts/glossary/#data-service).
...
Once all of your nodes are joined to the cluster, move on to the [next step](/enterprise_influxdb/v1.4/quickstart_installation/chrono_install)
