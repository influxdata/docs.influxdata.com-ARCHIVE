...
For metrics shared by both InfluxDB OSS and InfluxDB Enterprise, please refer to the [InfluxDB `_internal` documentation](/influxdb/v1.3/troubleshooting/internal_statistics).
