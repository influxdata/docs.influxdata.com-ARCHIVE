...
title: Clustering
aliases:
    - /enterprise/v1.4/concepts/clustering/
menu:
...
When a write comes in with values that have a timestamp in `2016-09-19` the cluster must first determine which shard within the shard group should receive the write. This is done by taking a hash of the `measurement` + sorted `tagset` (the [metaseries](/influxdb/v1.4/concepts/glossary/#metaseries)) and bucketing into the correct shard. In Go this looks like:
