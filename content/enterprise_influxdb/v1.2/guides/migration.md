...
aliases:
    - /enterprise/v1.2/guides/migration/
menu:
...
You can do this with [ALTER RETENTION POLICY](/influxdb/v1.2/query_language/database_management/#modify-retention-policies-with-alter-retention-policy).
