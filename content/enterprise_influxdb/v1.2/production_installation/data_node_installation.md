...
aliases:
    - /enterprise/v1.2/production_installation/data_node_installation/
menu:
...
The Production Installation process sets up two [data nodes](/enterprise_influxdb/v1.2/concepts/glossary#data-node)
...
[previous document](/enterprise_influxdb/v1.2/introduction/meta_node_installation/), run:
```
...
to set up the InfluxEnterprise web console](/enterprise_influxdb/v1.2/production_installation/web_console_installation/).
