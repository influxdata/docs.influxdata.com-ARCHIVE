...
menu:
  flux_0_x:
    ...
    weight: 1
aliases:
  - /flux/v0.x/functions/built-in/transformations/aggregates/tripleexponentialderivative/
---
...
- The function behaves the same way as the [`exponentialMovingAverage()`](/flux/v0.x/stdlib/built-in/transformations/aggregates/exponentialmovingaverage/) function:
