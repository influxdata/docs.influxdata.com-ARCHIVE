...
## group() Function
Flux's [`group()` function](/flux/v0.x/functions/transformations/group) defines the
...
_For more information, see the [`group()` function](/flux/v0.x/functions/transformations/group)._
