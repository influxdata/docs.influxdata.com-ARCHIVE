...
- The InfluxDB user interface (UI) does not currently support raw scalar output.
  Use [`map()`](/flux/v0.x/stdlib/built-in/transformations/map/) to add
  scalar values to output data.
- The [Flux REPL ](/flux/v0.x/guides/executing-queries/#influx-cli-in-flux-mode)
...
Use [`tableFind()`](/flux/v0.x/stdlib/built-in/transformations/stream-table/tablefind/)
to extract the **first** table whose [group key](/flux/v0.x/introduction/getting-started/#group-keys)
...
Use the [`getColumn()` function](/flux/v0.x/stdlib/built-in/transformations/stream-table/getcolumn/)
...
Use the [`getRecord()` function](/flux/v0.x/stdlib/built-in/transformations/stream-table/getrecord/)
...
Use [dot notation](/flux/v0.x/introduction/getting-started/syntax-basics/#objects)
