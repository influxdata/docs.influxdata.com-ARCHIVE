...
## histogram() function
The [`histogram()` function](/flux/v0.x/stdlib/built-in/transformations/histogram) approximates the
...
### linearBins()
The [`linearBins()` function](/flux/v0.x/stdlib/built-in/misc/linearbins) generates a list of linearly separated floats.
...
### logarithmicBins()
The [`logarithmicBins()` function](/flux/v0.x/stdlib/built-in/misc/logarithmicbins) generates a list of exponentially separated floats.
