...
##### InfluxDB v1.7+
Flux v0.x (technical preview) is built into InfluxDB v1.7 and can be used to query data stored in InfluxDB.
...
Flux's [`from()` function](/flux/v0.x/functions/inputs/from), which defines an InfluxDB data source, requires a `bucket` parameter.
...
You have multiple [options for writing and running Flux queries](/flux/v0.x/guides/executing-queries),
...
<div class="page-nav-btns">
  <a class="btn next" href="/flux/v0.x/introduction/getting-started/query-influxdb/">Query InfluxDB with Flux</a>
</div>
