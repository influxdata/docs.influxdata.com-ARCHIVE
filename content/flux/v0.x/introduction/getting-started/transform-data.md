...
This guide demonstrates using [Flux functions](/flux/v0.x/stdlib) to transform your data.
...
You can also [create custom functions](/flux/v0.x/stdlib/custom-functions) in your Flux queries.
_Functions are covered in detail in the [Flux functions](/flux/v0.x/stdlib) documentation._
...
This example uses the [`mean()` function](/flux/v0.x/stdlib/built-in/transformations/aggregates/mean)
...
## Window your data
Flux's [`window()` function](/flux/v0.x/stdlib/built-in/transformations/window) partitions records based on a time value.
...
Use the [`mean()` function](/flux/v0.x/stdlib/built-in/transformations/aggregates/mean) to average the `_value`s of each table.
...
To add one, use the [`duplicate()` function](/flux/v0.x/stdlib/built-in/transformations/duplicate)
...
[`aggregateWindow()` function](/flux/v0.x/stdlib/built-in/transformations/aggregates/aggregatewindow).
