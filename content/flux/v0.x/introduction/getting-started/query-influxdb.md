...
Flux's [`from()`](/flux/v0.x/functions/inputs/from) function defines an InfluxDB data source.
...
Use the pipe-forward operator (`|>`) to pipe data from your data source into the [`range()`](/flux/v0.x/functions/transformations/range)
