...
[built-in aggregate functions](/flux/v0.x/functions/built-in/transformations/aggregates/)
or create custom aggregate functions using the
[`reduce()`function](/flux/v0.x/functions/built-in/transformations/aggregates/reduce/).
...
the [`fn` parameter](/flux/v0.x/functions/built-in/transformations/aggregates/reduce/#fn).
...
{{% note %}}
The `reduce()` function's [`identity` parameter](/flux/v0.x/functions/built-in/transformations/aggregates/reduce/#identity)
...
{{% note %}}
To preserve existing columns, [use the `with` operator](/flux/v0.x/functions/built-in/transformations/aggregates/reduce/#preserve-columns)
...
[Creating custom functions](/flux/v0.x/functions/custom-functions)
...
The built-in [`mean()` function](/flux/v0.x/functions/built-in/transformations/aggregates/mean/)
