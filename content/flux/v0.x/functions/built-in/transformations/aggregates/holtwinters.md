...
- [`window()`](/flux/v0.x/functions/built-in/transformations/window/)
  with [selectors](/flux/v0.x/functions/built-in/transformations/selectors/)
  or [aggregates](/flux/v0.x/functions/built-in/transformations/aggregates/)
- [`aggregateWindow()`](/flux/v0.x/functions/built-in/transformations/aggregates/aggregatewindow)
