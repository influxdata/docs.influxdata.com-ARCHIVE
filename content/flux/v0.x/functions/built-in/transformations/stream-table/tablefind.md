...
{{% note %}}
You can use `t` from the example above as input for [`getColumn()`](/flux/v0.x/functions/built-in/transformations/stream-table/getcolumn/)
and [`getRecord()`](/flux/v0.x/functions/built-in/transformations/stream-table/getrecord/).
{{% /note %}}
