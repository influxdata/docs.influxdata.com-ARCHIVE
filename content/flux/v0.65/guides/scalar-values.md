...
Use the [`getColumn()` function](/flux/v0.65/stdlib/built-in/transformations/stream-table/getcolumn/)
...
Use the [`getRecord()` function](/flux/v0.65/stdlib/built-in/transformations/stream-table/getrecord/)
