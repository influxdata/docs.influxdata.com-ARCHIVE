...
[built-in `to()` function](/flux/v0.65/stdlib/built-in/outputs/to/).
...
If using the built-in `from()` function, use [`pivot()`](/flux/v0.65/stdlib/built-in/transformations/pivot/)
...
### Related functions
- [to()](/flux/v0.65/stdlib/built-in/outputs/to/)
