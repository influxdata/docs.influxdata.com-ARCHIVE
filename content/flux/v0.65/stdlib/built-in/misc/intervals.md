...
description: The intervals() function generates a set of time intervals over a range
  of time.
aliases:
  - /flux/v0.65/functions/misc/intervals
  - /flux/v0.65/functions/built-in/misc/intervals/
menu:
  flux_0_65:
    name: intervals
...
> The `intervals()` function is designed to be used with the `intervals` parameter of the [`window()` function](/flux/v0.65/stdlib/built-in/transformations/window).
