...
aliases:
  - /flux/v0.65/functions/transformations/aggregates/percentile
  - /flux/v0.65/functions/built-in/transformations/aggregates/percentile
  - /flux/v0.65/functions/built-in/transformations/aggregates/quantile/
menu:
  flux_0_65:
    name: quantile
    parent: Aggregates
