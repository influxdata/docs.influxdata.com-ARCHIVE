...
menu:
  flux_0_65:
    ...
    weight: 1
aliases:
  - /flux/v0.65/functions/built-in/transformations/aggregates/holtwinters/
---
...
- [`window()`](/flux/v0.65/stdlib/built-in/transformations/window/)
  with [selectors](/flux/v0.65/stdlib/built-in/transformations/selectors/)
  or [aggregates](/flux/v0.65/stdlib/built-in/transformations/aggregates/)
