...
aliases:
  - /flux/v0.65/functions/transformations/range
  - /flux/v0.65/functions/built-in/transformations/range/
menu:
  flux_0_65:
    name: range
...
> Time values in Flux must be in [RFC3339 format](/flux/v0.65/language/types#timestamp-format).
