...
The `median()` function is a special application of the [`percentile()` function](/flux/v0.12/functions/transformations/aggregates/percentile)
...
> It is a special application of the [`percentile()` function](/flux/v0.12/functions/transformations/aggregates/percentile) which
> uses an approximation implementation that requires floats.
> You can convert your value column to a float column using the [`toFloat()` function](/flux/v0.12/functions/transformations/type-conversions/tofloat).
