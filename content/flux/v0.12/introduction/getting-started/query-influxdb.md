...
_**If you haven't already, make sure to install InfluxDB v1.7+, [enable Flux](/flux/v0.12/introduction/installation),
and choose a [tool for writing Flux queries](/flux/v0.12/introduction/getting-started#tools-for-working-with-flux).**_
...
Flux's [`from()`](/flux/v0.12/functions/inputs/from) function defines an InfluxDB data source.
It requires a [`bucket`](/flux/v0.12/introduction/getting-started/#buckets) parameter.
...
<div class="page-nav-btns">
  <a class="btn prev" href="/flux/v0.12/introduction/getting-started/">Get started with Flux</a>
  <a class="btn next" href="/flux/v0.12/introduction/getting-started/transform-data/">Transform your data</a>
</div>
