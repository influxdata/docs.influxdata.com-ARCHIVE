...
aliases:
  - /flux/v0.33/functions/misc/intervals
menu:
  flux_0_33:
    name: intervals
...
> The `intervals()` function is designed to be used with the `intervals` parameter of the [`window()` function](/flux/v0.33/functions/built-in/transformations/window).
