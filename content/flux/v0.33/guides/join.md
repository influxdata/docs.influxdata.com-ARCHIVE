...
The [`join()` function](/flux/v0.33/functions/built-in/transformations/join) merges two or more
...
With the two streams of data joined into a single table, use the [`map()` function](/flux/v0.33/functions/built-in/transformations/map)
