...
- When using functions that operate on a single row at a time (
  ...
  [`map()`](/flux/v0.33/functions/built-in/transformations/map/),
  [`reduce()`](/flux/v0.33/functions/built-in/transformations/aggregates/reduce) ).
...
The following example uses the [`map()` function](/flux/v0.33/functions/built-in/transformations/map/)
...
The following example uses the [`aggregateWindow()`](/flux/v0.33/functions/built-in/transformations/aggregates/aggregatewindow/)
and [`reduce()`](/flux/v0.33/functions/built-in/transformations/aggregates/reduce/)
