...
## group() Function
Flux's [`group()` function](/flux/v0.33/functions/built-in/transformations/group) defines the
...
_For more information, see the [`group()` function](/flux/v0.33/functions/built-in/transformations/group)._
