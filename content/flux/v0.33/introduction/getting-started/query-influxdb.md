...
_**If you haven't already, make sure to install InfluxDB v1.7+, [enable Flux](/flux/v0.33/introduction/installation),
and choose a [tool for writing Flux queries](/flux/v0.33/introduction/getting-started#tools-for-working-with-flux).**_
...
Flux's [`from()`](/flux/v0.33/functions/built-in/inputs/from) function defines an InfluxDB data source.
It requires a [`bucket`](/flux/v0.33/introduction/getting-started/#buckets) parameter.
...
Use the pipe-forward operator (`|>`) to pipe data from your data source into the [`range()`](/flux/v0.33/functions/built-in/transformations/range)
function, which specifies a time range for your query.
It accepts two properties: `start` and `stop`.
Ranges can be **relative** using negative [durations](/flux/v0.33/language/lexical-elements#duration-literals)
or **absolute** using [timestamps](/flux/v0.33/language/lexical-elements#date-and-time-literals).
...
<div class="page-nav-btns">
  <a class="btn prev" href="/flux/v0.33/introduction/getting-started/">Get started with Flux</a>
  <a class="btn next" href="/flux/v0.33/introduction/getting-started/transform-data/">Transform your data</a>
</div>
