...
- Add stream table index functions (
  [`tableFind()`](/flux/v0.33/functions/built-in/transformations/stream-table/tablefind/),
  [`getRecord()`](/flux/v0.33/functions/built-in/transformations/stream-table/getrecord/),
  [`getColumn()`](/flux/v0.33/functions/built-in/transformations/stream-table/getcolumn/)
  ).
