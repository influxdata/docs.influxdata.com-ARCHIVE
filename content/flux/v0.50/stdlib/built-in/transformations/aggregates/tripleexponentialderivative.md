...
menu:
  flux_0_50:
    ...
    weight: 1
aliases:
  - /flux/v0.50/functions/built-in/transformations/aggregates/tripleexponentialderivative/
---
...
- The function behaves the same way as the [`exponentialMovingAverage()`](/flux/v0.50/stdlib/built-in/transformations/aggregates/exponentialmovingaverage/) function:
