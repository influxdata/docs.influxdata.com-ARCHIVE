...
menu:
  flux_0_50:
    ...
    weight: 1
aliases:
  - /flux/v0.50/functions/built-in/transformations/aggregates/doubleema/
---
...
data at double the rate of [`exponentialMovingAverage()`](/flux/v0.50/stdlib/built-in/transformations/aggregates/exponentialmovingaverage/).
...
- `doubleEMA()` inherits all [exponential moving average rules](/flux/v0.50/stdlib/built-in/transformations/aggregates/exponentialmovingaverage/#exponential-moving-average-rules).
