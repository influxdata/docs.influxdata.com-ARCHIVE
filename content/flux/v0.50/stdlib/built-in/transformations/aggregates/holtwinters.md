...
menu:
  flux_0_50:
    ...
    weight: 1
aliases:
  - /flux/v0.50/functions/built-in/transformations/aggregates/holtwinters/
---
...
- [`window()`](/flux/v0.50/stdlib/built-in/transformations/window/)
  with [selectors](/flux/v0.50/stdlib/built-in/transformations/selectors/)
  or [aggregates](/flux/v0.50/stdlib/built-in/transformations/aggregates/)
- [`aggregateWindow()`](/flux/v0.50/stdlib/built-in/transformations/aggregates/aggregatewindow)
