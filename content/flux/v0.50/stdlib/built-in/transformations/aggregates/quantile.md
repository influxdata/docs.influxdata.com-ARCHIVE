...
description: >
  The quantile() function outputs non-null records with values that fall
  within the specified quantile or the non-null record with the value that represents
  the specified quantile.
aliases:
  - /flux/v0.50/functions/transformations/aggregates/percentile
  - /flux/v0.50/functions/built-in/transformations/aggregates/percentile
  - /flux/v0.50/functions/built-in/transformations/aggregates/quantile/
menu:
  flux_0_50:
    name: quantile
    parent: Aggregates
