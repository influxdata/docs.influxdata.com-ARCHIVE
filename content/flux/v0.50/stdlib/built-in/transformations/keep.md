...
aliases:
  - /flux/v0.50/functions/transformations/keep
  - /flux/v0.50/functions/built-in/transformations/keep/
menu:
  flux_0_50:
    name: keep
...
_It is the inverse of [`drop`](/flux/v0.50/stdlib/built-in/transformations/drop)._
