...
description: The pivot() function collects values stored vertically (column-wise)
  in a table and aligns them horizontally (row-wise) into logical sets.
aliases:
  - /flux/v0.50/functions/transformations/pivot
  - /flux/v0.50/functions/built-in/transformations/pivot/
menu:
  flux_0_50:
    name: pivot
