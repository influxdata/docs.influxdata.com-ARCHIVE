...
weight: 1
aliases:
  - /flux/v0.50/functions/custom-functions/custom-aggregate/
---

To aggregate your data, use the Flux
[built-in aggregate functions](/flux/v0.50/stdlib/built-in/transformations/aggregates/)
or create custom aggregate functions using the
[`reduce()`function](/flux/v0.50/stdlib/built-in/transformations/aggregates/reduce/).
...
- The output table has the same [group key](/flux/v0.50/introduction/getting-started/#group-keys) as the input table.

## How reduce() works
The `reduce()` function operates on one row at a time using the function defined in
the [`fn` parameter](/flux/v0.50/stdlib/built-in/transformations/aggregates/reduce/#fn).
The `fn` function maps keys to specific values using two [objects](/flux/v0.50/introduction/getting-started/syntax-basics/#objects)
...
{{% note %}}
The `reduce()` function's [`identity` parameter](/flux/v0.50/stdlib/built-in/transformations/aggregates/reduce/#identity)
...
{{% note %}}
To preserve existing columns, [use the `with` operator](/flux/v0.50/stdlib/built-in/transformations/aggregates/reduce/#preserve-columns)
...
1. Are part of the input table's [group key](/flux/v0.50/introduction/getting-started/#group-keys).
...
[Creating custom functions](/flux/v0.50/stdlib/custom-functions)
...
The built-in [`mean()` function](/flux/v0.50/stdlib/built-in/transformations/aggregates/mean/)
