...
- Add stream table index functions (
  [`tableFind()`](/flux/v0.50/stdlib/built-in/transformations/stream-table/tablefind/),
  [`getRecord()`](/flux/v0.50/stdlib/built-in/transformations/stream-table/getrecord/),
  [`getColumn()`](/flux/v0.50/stdlib/built-in/transformations/stream-table/getcolumn/)
  ).
