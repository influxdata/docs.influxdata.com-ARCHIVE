...
To use Flux string interpolation, enclose embedded [expressions](/flux/v0.50/language/expressions/)
...
Use the [string() function](/flux/v0.50/stdlib/built-in/transformations/type-conversions/string/)
...
[Objects](/flux/v0.50/language/expressions/#object-literals) consist of key-value pairs.
Use [dot notation](/flux/v0.50/language/expressions/#member-expressions)
