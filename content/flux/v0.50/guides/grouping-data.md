...
## group() Function
Flux's [`group()` function](/flux/v0.50/stdlib/built-in/transformations/group) defines the
...
_For more information, see the [`group()` function](/flux/v0.50/stdlib/built-in/transformations/group)._
