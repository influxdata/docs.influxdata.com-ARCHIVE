...
_**Chronograf v1.7+** and **InfluxDB v1.7 with [Flux enabled](/flux/v0.50/introduction/installation)**
...
> [Flux enabled](/flux/v0.50/introduction/installation).
...
[windowing and aggregation](/flux/v0.50/guides/windowing-aggregating) operations with dashboard refreshes.
