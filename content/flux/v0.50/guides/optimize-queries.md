...
- [map()](/flux/v0.50/stdlib/built-in/transformations/map/)
- [reduce()](/flux/v0.50/stdlib/built-in/transformations/aggregates/reduce/)
- [window()](/flux/v0.50/stdlib/built-in/transformations/window/)
- [join()](/flux/v0.50/stdlib/built-in/transformations/join/)
- [union()](/flux/v0.50/stdlib/built-in/transformations/union/)
- [pivot()](/flux/v0.50/stdlib/built-in/transformations/pivot/)
...
to downsample the data and then query the downsampled data instead.
