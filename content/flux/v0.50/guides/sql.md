...
The [Flux](/flux/v0.50) `sql` package provides functions for working with SQL data sources.
[`sql.from()`](/flux/v0.50/stdlib/sql/from/) lets you query SQL data sources
...
_See the [`sql.from()` documentation](/flux/v0.50/stdlib/sql/from/) for
