...
The [Flux](/flux/v0.64) `sql` package provides functions for working with SQL data sources.
[`sql.from()`](/flux/v0.64/stdlib/sql/from/) lets you query SQL data sources
...
_See the [`sql.from()` documentation](/flux/v0.64/stdlib/sql/from/) for
