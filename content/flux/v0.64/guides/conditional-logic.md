...
The following example uses the [`map()` function](/flux/v0.64/stdlib/built-in/transformations/map/)
...
The following example uses the [`aggregateWindow()`](/flux/v0.64/stdlib/built-in/transformations/aggregates/aggregatewindow/)
and [`reduce()`](/flux/v0.64/stdlib/built-in/transformations/aggregates/reduce/)
