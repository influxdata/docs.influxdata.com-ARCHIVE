...
- [Get started with Flux](/flux/v0.64/introduction/getting-started/) for a conceptual overview of Flux.
...
1. Use the [`stateDuration()`](/flux/v0.64/stdlib/built-in/transformations/stateduration/) function to calculate how long a column value has remained the same value (or state). Include the following information:
