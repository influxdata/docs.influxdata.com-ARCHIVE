...
The `geo.filterRows()` function filters data by a specified geographic region with
the option of strict filtering.
This function is a combination of [`geo.gridFilter()`](/flux/v0.64/stdlib/experimental/geo/gridfilter/)
and [`geo.strictFilter()`](/flux/v0.64/stdlib/experimental/geo/strictfilter/).
