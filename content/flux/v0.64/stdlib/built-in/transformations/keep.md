...
aliases:
  - /flux/v0.64/functions/transformations/keep
  - /flux/v0.64/functions/built-in/transformations/keep/
menu:
  flux_0_64:
    name: keep
...
_It is the inverse of [`drop`](/flux/v0.64/stdlib/built-in/transformations/drop)._
