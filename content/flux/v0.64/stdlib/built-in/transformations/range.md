...
aliases:
  - /flux/v0.64/functions/transformations/range
  - /flux/v0.64/functions/built-in/transformations/range/
menu:
  flux_0_64:
    name: range
...
> Time values in Flux must be in [RFC3339 format](/flux/v0.64/language/types#timestamp-format).
