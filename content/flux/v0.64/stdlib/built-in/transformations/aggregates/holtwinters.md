...
menu:
  flux_0_64:
    ...
    weight: 1
aliases:
  - /flux/v0.64/functions/built-in/transformations/aggregates/holtwinters/
---
...
- [`window()`](/flux/v0.64/stdlib/built-in/transformations/window/)
  with [selectors](/flux/v0.64/stdlib/built-in/transformations/selectors/)
  or [aggregates](/flux/v0.64/stdlib/built-in/transformations/aggregates/)
