...
menu:
  flux_0_64:
    ...
    weight: 1
aliases:
  - /flux/v0.64/functions/built-in/transformations/aggregates/tripleexponentialderivative/
---
...
- The function behaves the same way as the [`exponentialMovingAverage()`](/flux/v0.64/stdlib/built-in/transformations/aggregates/exponentialmovingaverage/) function:
