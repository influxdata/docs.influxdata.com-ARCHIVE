...
description: The `histogramQuantile()` function approximates a quantile given a histogram
  that approximates the cumulative distribution of the dataset.
aliases:
  - /flux/v0.64/functions/transformations/aggregates/histogramquantile
  - /flux/v0.64/functions/built-in/transformations/aggregates/histogramquantile/
menu:
  flux_0_64:
