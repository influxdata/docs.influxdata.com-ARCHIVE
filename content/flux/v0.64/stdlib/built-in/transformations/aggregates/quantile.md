...
aliases:
  - /flux/v0.64/functions/transformations/aggregates/percentile
  - /flux/v0.64/functions/built-in/transformations/aggregates/percentile
  - /flux/v0.64/functions/built-in/transformations/aggregates/quantile/
menu:
  flux_0_64:
    name: quantile
    parent: Aggregates
