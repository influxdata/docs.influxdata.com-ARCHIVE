...
This likely seems familiar if you've already been through through the other [getting started guides](/flux/v0.64/introduction/getting-started).
...
_More information about creating custom functions is available in the [Custom functions](/flux/v0.64/stdlib/custom-functions) documentation._
...
<div class="page-nav-btns">
  <a class="btn prev" href="/flux/v0.64/introduction/getting-started/transform-data/">Transform your data</a>
</div>
