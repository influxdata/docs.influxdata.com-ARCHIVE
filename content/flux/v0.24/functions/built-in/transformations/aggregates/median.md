...
aliases:
  - /flux/v0.24/functions/transformations/aggregates/median
menu:
  flux_0_24:
    name: median
    parent: Aggregates
...
The `median()` function is a special application of the [`quantile()` function](/flux/v0.24/functions/built-in/transformations/aggregates/quantile)
...
> It is a special application of the [`quantile()` function](/flux/v0.24/functions/built-in/transformations/aggregates/quantile) which
> uses an approximation implementation that requires floats.
> You can convert your value column to a float column using the [`toFloat()` function](/flux/v0.24/functions/built-in/transformations/type-conversions/tofloat).
