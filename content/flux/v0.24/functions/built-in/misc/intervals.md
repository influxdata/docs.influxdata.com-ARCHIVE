...
aliases:
  - /flux/v0.24/functions/misc/intervals
menu:
  flux_0_24:
    name: intervals
...
> The `intervals()` function is designed to be used with the `intervals` parameter of the [`window()` function](/flux/v0.24/functions/built-in/transformations/window).
