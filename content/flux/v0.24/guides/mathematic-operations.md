...
This article describes how to use [Flux arithmetic operators](/flux/v0.24/language/operators/#arithmetic-operators)
...
<p style="font-size:.85rem;font-style:italic;margin-top:-.8rem;">See <a href="/flux/v0.24/guides/executing-queries/#influx-cli-in-flux-mode">Influx CLI in "Flux mode"</a></p>
...
To convert operands to the same type, use [type-conversion functions](/flux/v0.24/functions/built-in/transformations/type-conversions/)
...
Flux lets you [create custom functions](/flux/v0.24/functions/custom-functions) that use mathematic operations.
...
- [Handle piped-forward data](/flux/v0.24/functions/custom-functions/#functions-that-manipulate-pipe-forwarded-data).
- Use the [`map()` function](/flux/v0.24/functions/built-in/transformations/map) to iterate over each row.
...
[`float()` function](/flux/v0.24/functions/built-in/transformations/type-conversions/float)
