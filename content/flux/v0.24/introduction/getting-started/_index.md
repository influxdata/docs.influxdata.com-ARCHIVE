...
##### InfluxDB v1.7+
Flux v0.24 (technical preview) is built into InfluxDB v1.7 and can be used to query data stored in InfluxDB.
...
_If you use Docker, the [InfluxData Sandbox](/platform/install-and-deploy/deploying/sandbox-install)
...
Flux's [`from()` function](/flux/v0.24/functions/built-in/inputs/from), which defines an InfluxDB data source, requires a `bucket` parameter.
...
You have multiple [options for writing and running Flux queries](/flux/v0.24/guides/executing-queries),
...
<div class="page-nav-btns">
  <a class="btn next" href="/flux/v0.24/introduction/getting-started/query-influxdb/">Query InfluxDB with Flux</a>
</div>
