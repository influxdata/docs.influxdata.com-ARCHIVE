...
## Windowing data
Use the [`window()` function](/flux/v0.36/functions/built-in/transformations/window) to group your data based on time bounds.
...
## Aggregate data
[Aggregate functions](/flux/v0.36/functions/built-in/transformations/aggregates) take the values
...
For this example, use the [`mean()` function](/flux/v0.36/functions/built-in/transformations/aggregates/mean)
...
Use the [`duplicate()` function](/flux/v0.36/functions/built-in/transformations/duplicate) to
...
Flux also provides the [`aggregateWindow()` function](/flux/v0.36/functions/built-in/transformations/aggregates/aggregatewindow)
