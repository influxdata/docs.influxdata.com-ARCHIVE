...
description: Use the Prometheus output data format to serialize data from Telegraf metrics.
menu:
  telegraf_1_14:
    name: Prometheus
    weight: 20
