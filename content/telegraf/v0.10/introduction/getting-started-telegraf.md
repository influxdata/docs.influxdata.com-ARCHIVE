...
* List all [measurements](/influxdb/v0.10/concepts/glossary/#measurement) in the `telegraf` [database](/influxdb/v0.10/concepts/glossary/#database):
...
* List all [field keys](/influxdb/v0.10/concepts/glossary/#field-key) by measurement:
...
* Select a sample of the data in the [field](/influxdb/v0.10/concepts/glossary/#field) `usage_idle` in the measurement `cpu_usage_idle`:
