...
aliases:
  - /telegraf/v1.13/introduction/getting_started/
menu:
  telegraf_1_13:
...
Before starting the Telegraf server you need to edit and/or create an initial configuration that specifies your desired [inputs](/telegraf/v1.13/plugins/inputs/) (where the metrics come from) and [outputs](/telegraf/v1.13/plugins/outputs/) (where the metrics go). There are [several ways](/telegraf/v1.13/administration/configuration/) to create and edit the configuration file.
