...
Global [tags](/{{< latest "influxdb" >}}/concepts/glossary/#tag) can be specified in the `[global_tags]` section of the config file
...
* **name_override**: Override the base name of the [measurement](/{{< latest "influxdb" >}}/concepts/glossary/#measurement).
...
[measurement](/{{< latest "influxdb" >}}/concepts/glossary/#measurement) names and if it matches, the field is emitted.
...
This plugin will emit [measurements](/{{< latest "influxdb" >}}/concepts/glossary/#measurement) with the name `cpu_total`
...
This plugin will emit measurements with two additional [tags](/{{< latest "influxdb" >}}/concepts/glossary/#tag): `tag1=foo` and
`tag2=bar`
