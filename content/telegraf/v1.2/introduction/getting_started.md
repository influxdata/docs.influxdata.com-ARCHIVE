...
aliases:
    - telegraf/v1.2/introduction/getting-started-telegraf/
menu:
  telegraf_1_2:
...
Before starting the Telegraf server you need to edit and/or create an initial configuration that specifies your desired [inputs](/telegraf/v1.2/inputs/) (where the metrics come from) and [outputs](/telegraf/v1.2/outputs/) (where the metrics go). There are [several ways](/telegraf/v1.2/administration/configuration/) to create and edit the configuration file.
