...
## [Full Telegraf plugins list](/telegraf/v1.15/plugins/plugin-list/)
View the full list of available Telegraf plugins.

### Telegraf input plugins
The [Telegraf input plugins](/telegraf/v1.15/plugins/inputs/) collect metrics from the system, services, or third party APIs.

### Telegraf output plugins
The [Telegraf output plugins](/telegraf/v1.15/plugins/outputs/) write metrics to various destinations.

### Telegraf aggregator plugins
The [Telegraf aggregator plugins](/telegraf/v1.15/plugins/aggregators/) create aggregate metrics (for example, mean, min, max, quantiles, etc.)

### Telegraf processor plugins
The [Telegraf processor plugins](/telegraf/v1.15/plugins/processors/) transform, decorate, and filter metrics.
