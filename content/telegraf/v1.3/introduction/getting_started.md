...
aliases:
    - telegraf/v1.3/introduction/getting-started-telegraf/
menu:
  telegraf_1_3:
...
Before starting the Telegraf server you need to edit and/or create an initial configuration that specifies your desired [inputs](/telegraf/v1.3/inputs/) (where the metrics come from) and [outputs](/telegraf/v1.3/outputs/) (where the metrics go). There are [several ways](/telegraf/v1.3/administration/configuration/) to create and edit the configuration file.
...
* List all [measurements](/influxdb/v1.3/concepts/glossary/#measurement) in the `telegraf` [database](/influxdb/v1.3/concepts/glossary/#database):
...
* List all [field keys](/influxdb/v1.3/concepts/glossary/#field-key) by measurement:
...
* Select a sample of the data in the [field](/influxdb/v1.3/concepts/glossary/#field) `usage_idle` in the measurement `cpu_usage_idle`:
