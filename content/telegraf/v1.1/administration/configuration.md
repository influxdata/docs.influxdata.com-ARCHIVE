...
title: Configuration
aliases:
    - telegraf/v1.1/introduction/configuration/
menu:
  telegraf_1_1:
    name: Configuration
    weight: 20
...
Global [tags](/influxdb/latest/concepts/glossary/#tag) can be specified in the `[global_tags]` section of the config file
...
* **metric_batch_size**: Telegraf will send metrics to output in batches of at
...
* **name_override**: Override the base name of the [measurement](/influxdb/latest/concepts/glossary/#measurement).
...
[measurement](/influxdb/latest/concepts/glossary/#measurement) names and if it matches, the field is emitted.
...
This plugin will emit [measurements](/influxdb/latest/concepts/glossary/#measurement) with the name `cpu_total`
...
This plugin will emit measurements with two additional [tags](/influxdb/latest/concepts/glossary/#tag): `tag1=foo` and
`tag2=bar`
