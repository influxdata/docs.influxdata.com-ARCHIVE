...
Global [tags](/influxdb/v1.1/concepts/glossary/#tag) can be specified in the `[global_tags]` section of the config file
...
* **name_override**: Override the base name of the [measurement](/influxdb/v1.1/concepts/glossary/#measurement).
...
[measurement](/influxdb/v1.1/concepts/glossary/#measurement) names and if it matches, the field is emitted.
...
This plugin will emit [measurements](/influxdb/v1.1/concepts/glossary/#measurement) with the name `cpu_total`
...
This plugin will emit measurements with two additional [tags](/influxdb/v1.1/concepts/glossary/#tag): `tag1=foo` and
`tag2=bar`
