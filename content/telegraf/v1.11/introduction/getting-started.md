...
aliases:
  - /telegraf/v1.11/introduction/getting_started/
menu:
  telegraf_1_11:
...
Before starting the Telegraf server you need to edit and/or create an initial configuration that specifies your desired [inputs](/telegraf/v1.11/plugins/inputs/) (where the metrics come from) and [outputs](/telegraf/v1.11/plugins/outputs/) (where the metrics go). There are [several ways](/telegraf/v1.11/administration/configuration/) to create and edit the configuration file.
