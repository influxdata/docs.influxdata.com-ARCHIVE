...
- [InfluxDB Line Protocol](/telegraf/v1.11/data_formats/input/influx/)
- [collectd](/telegraf/v1.11/data_formats/input/collectd/)
- [CSV](/telegraf/v1.11/data_formats/input/csv/)
- [Dropwizard](/telegraf/v1.11/data_formats/input/dropwizard/)
- [Graphite](/telegraf/v1.11/data_formats/input/graphite/)
- [Grok](/telegraf/v1.11/data_formats/input/grok/)
- [JSON](/telegraf/v1.11/data_formats/input/json/)
- [logfmt](/telegraf/v1.11/data_formats/input/logfmt/)
- [Nagios](/telegraf/v1.11/data_formats/input/nagios/)
- [Value](/telegraf/v1.11/data_formats/input/value/), ie: 45 or "booyah"
- [Wavefront](/telegraf/v1.11/data_formats/input/wavefront/)
...
[metrics]: /telegraf/v1.11/concepts/metrics/
